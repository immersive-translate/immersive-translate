...
`,MOCK:"0",DEBUG:"0",INSTALL_FROM:"chrome_zip"};var Tn=class{constructor({name:t,build:n,detect:r,helper:o,parse:a}){this.name=t,this.helper=o,this.build=n,this.detect=i=>{if(typeof i!="string")throw new Error("Expected string content!");return r(i)},this.parse=(i,u)=>{if(typeof i!="string")throw new Error("Expected string content!");return a(i,u)}}},Se=e=>new Tn(e);var Za="ssa",gt={toMilliseconds:e=>{let t=/^\s*(\d+:)?(\d{1,2}):(\d{1,2})(?:[.,](\d{1,3}))?\s*$/.exec(e);if(!t)throw new Error(`Invalid time format: ${e}`);let n=t[1]?parseInt(t[1].replace(":","")):0,r=parseInt(t[2]),o=parseInt(t[3]),a=t[4]?parseInt(t[4]):0;return n*3600*1e3+r*60*1e3+o*1e3+a*10},toTimeString:e=>{let t=Math.floor(e/1e3/3600),n=Math.floor(e/1e3/60%60),r=Math.floor(e/1e3%60),o=Math.floor(e%1e3/10);return`${t}:${n<10?"0":""}${n}:${r<10?"0":""}${r}.${o<10?"0":""}${o}`}},xn=(e,t)=>{let n,r=null,o=[],a=t.eol||`\r
