(()=>{var Xa=Object.defineProperty;var Za=(e,t)=>{for(var n in t)Xa(e,n,{get:t[n],enumerable:!0})};var S={BUILD_TIME:"2023-09-04T16:29:41.000Z",VERSION:"0.9.0",PROD:"1",REDIRECT_URL:"https://dash.immersivetranslate.com/auth-done/",PROD_API:"0",BETA:"0",IMMERSIVE_TRANSLATE_INJECTED_CSS:`:root {
...
`;for(let o=0;o<e.length;o++){let a=e[o];if(!a.type||a.type==="caption"){n+=(a.index?a.index:o+1).toString()+r,n+=`${Pt.toTimeString(a.start)} --> ${Pt.toTimeString(a.end)}${r}`,n+=a.text+r,n+=r;continue}t.verbose}return n},vi=e=>/\d+\r?\n\d{1,2}:\d{1,2}:\d{1,2}(?:[.,]\d{1,3})?\s*-->\s*\d{1,2}:\d{1,2}:\d{1,2}(?:[.,]\d{1,3})?/.test(e),Kr=Se({name:yi,build:xi,detect:vi,helper:Pt,parse:Ti});var wi="sub",_n=25,Si=(e,t)=>{t.fps||=_n;let n=t.fps>0?t.fps:_n,r=[],o=t.eol||`\r
