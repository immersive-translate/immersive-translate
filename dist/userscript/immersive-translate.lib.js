...
`, IMMERSIVE_TRANSLATE_COMMON_CSS: '#mount#mount {\n  /* --primary: rgb(227, 59, 126); */\n  --primary: #ea4c89;\n  --primary-hover: #f082ac;\n}\n\nli.select-link.select-link:hover > ul {\n  display: none;\n}\nli.select-link.select-link > ul {\n  display: none;\n}\nli.select-link.select-link a:focus ~ ul {\n  display: none;\n}\n\nli.select-link.select-link a:active ~ ul {\n  display: none;\n}\nli.select-link-active.select-link-active > ul {\n  display: flex;\n}\nli.select-link-active.select-link-active:hover > ul {\n  display: flex;\n}\n\nli.select-link-active.select-link-active a:focus ~ ul {\n  display: flex;\n}\n\nli.select-link-active.select-link-active a:active ~ ul {\n  display: flex;\n}\nul.select-link-ul.select-link-ul {\n  right: 0px;\n  left: auto;\n}\n\na.select-link-selected {\n  background-color: var(--primary-focus);\n}\n.immersive-translate-no-select {\n  -webkit-touch-callout: none; /* iOS Safari */\n  -webkit-user-select: none; /* Safari */\n  -khtml-user-select: none; /* Konqueror HTML */\n  -moz-user-select: none; /* Old versions of Firefox */\n  -ms-user-select: none; /* Internet Explorer/Edge */\n  user-select: none;\n}\n\n/* li[role="list"].no-arrow > a::after { */\n/*   background-image: none; */\n/*   width: 0; */\n/*   color: var(--color); */\n/* } */\nli[role="list"].no-arrow {\n  margin-left: 8px;\n  padding-right: 0;\n}\nli[role="list"] > a::after {\n  -webkit-margin-start: 0.2rem;\n  margin-inline-start: 0.2rem;\n}\n\nli[role="list"].no-arrow > a,\nli[role="list"].no-arrow > a:link,\nli[role="list"].no-arrow > a:visited {\n  color: var(--secondary);\n}\n\nselect.min-select {\n  --form-element-spacing-horizontal: 0;\n  margin-bottom: 0;\n  max-width: 128px;\n  color: var(--primary);\n  font-size: 14px;\n  border: none;\n  padding: 0;\n  padding-right: 20px;\n  background-position: center right 0;\n  background-size: 16px auto;\n  text-overflow: ellipsis;\n  text-align: right;\n  color: var(--color);\n}\nselect.min-select-secondary {\n  color: var(--color);\n}\nselect.min-select:focus {\n  outline: none;\n  border: none;\n  --box-shadow: none;\n}\nselect.min-select-no-arrow {\n  background-image: none;\n  padding-right: 0;\n}\n\nselect.min-select-left {\n  padding-right: 0px;\n  /* padding-left: 24px; */\n  /* background-position: center left 0; */\n  text-overflow: ellipsis;\n  text-align: left;\n}\n\n.muted {\n  color: var(--muted-color);\n}\n\n.select.button-select {\n  --background-color: var(--secondary-hover);\n  --border-color: var(--secondary-hover);\n  --color: var(--secondary-inverse);\n  cursor: pointer;\n  --box-shadow: var(--button-box-shadow, 0 0 0 rgba(0, 0, 0, 0));\n  padding: var(--form-element-spacing-vertical)\n    var(--form-element-spacing-horizontal);\n  border: var(--border-width) solid var(--border-color);\n  border-radius: var(--border-radius);\n  outline: none;\n  background-color: var(--background-color);\n  box-shadow: var(--box-shadow);\n  color: var(--color);\n  font-weight: var(--font-weight);\n  font-size: 16px;\n  line-height: var(--line-height);\n  text-align: center;\n  cursor: pointer;\n  transition: background-color var(--transition), border-color var(--transition),\n    color var(--transition), box-shadow var(--transition);\n  -webkit-appearance: button;\n  margin: 0;\n  margin-bottom: 0px;\n  overflow: visible;\n  font-family: inherit;\n  text-transform: none;\n}\n', IMMERSIVE_TRANSLATE_POPUP_CSS: 'html {\n  font-size: 17px;\n  --font-size: 17px;\n}\n\nbody {\n  padding: 0;\n  margin: 0;\n  min-width: 250px;\n  border-radius: 10px;\n}\n\n#mount#mount {\n  --font-family: system-ui, -apple-system, "Segoe UI", "Roboto", "Ubuntu",\n    "Cantarell", "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji",\n    "Segoe UI Symbol", "Noto Color Emoji";\n  --line-height: 1.5;\n  --font-weight: 400;\n  --font-size: 16px;\n  --border-radius: 4px;\n  --border-width: 1px;\n  --outline-width: 3px;\n  --spacing: 16px;\n  --typography-spacing-vertical: 24px;\n  --block-spacing-vertical: calc(var(--spacing) * 2);\n  --block-spacing-horizontal: var(--spacing);\n  --grid-spacing-vertical: 0;\n  --grid-spacing-horizontal: var(--spacing);\n  --form-element-spacing-vertical: 12px;\n  --form-element-spacing-horizontal: 16px;\n  --nav-element-spacing-vertical: 16px;\n  --nav-element-spacing-horizontal: 8px;\n  --nav-link-spacing-vertical: 8px;\n  --nav-link-spacing-horizontal: 8px;\n  --form-label-font-weight: var(--font-weight);\n  --transition: 0.2s ease-in-out;\n  --modal-overlay-backdrop-filter: blur(4px);\n}\n#mount {\n  min-width: 250px;\n}\n.main-button {\n  font-size: 14px;\n  vertical-align: middle;\n}\n\n.pt-4 {\n  padding-top: 24px;\n}\n.p-2 {\n  padding: 8px;\n}\n.pl-5 {\n  padding-left: 48px;\n}\n.p-0 {\n  padding: 0;\n}\n.pl-2 {\n  padding-left: 8px;\n}\n.pl-4 {\n  padding-left: 24px;\n}\n.pt-2 {\n  padding-top: 8px;\n}\n\n.pb-2 {\n  padding-bottom: 8px;\n}\n\n.pr-5 {\n  padding-right: 48px;\n}\n.text-sm {\n  font-size: 14px;\n}\n\n.flex {\n  display: flex;\n}\n.justify-between {\n  justify-content: space-between;\n}\n\n.mb-2 {\n  margin-bottom: 8px;\n}\n.inline-block {\n  display: inline-block;\n}\n\n.py-2 {\n  padding-top: 8px;\n  padding-bottom: 8px;\n}\n\n.mt-2 {\n  margin-top: 8px;\n}\n.mt-0 {\n  margin-top: 0;\n}\n\n.mb-1 {\n  margin-bottom: 4px;\n}\n.ml-4 {\n  margin-left: 24px;\n}\n.ml-3 {\n  margin-left: 16px;\n}\n.ml-2 {\n  margin-left: 8px;\n}\n.mr-1 {\n  margin-right: 4px;\n}\n.pl-3 {\n  padding-left: 12px;\n}\n.pr-3 {\n  padding-right: 12px;\n}\n.p-3 {\n  padding: 12px;\n}\n.mt-4 {\n  margin-top: 24px;\n}\n.py-0 {\n  padding-top: 0;\n  padding-bottom: 0;\n}\n\n.left-auto {\n  left: auto !important;\n}\n\n.max-h-28 {\n  max-height: 112px;\n}\n.max-h-30 {\n  max-height: 120px;\n}\n.overflow-y-scroll {\n  overflow-y: scroll;\n}\n.text-xs {\n  font-size: 12px;\n}\n\n.flex-1 {\n  flex: 1;\n}\n.flex-3 {\n  flex: 3;\n}\n.flex-4 {\n  flex: 4;\n}\n.flex-2 {\n  flex: 2;\n}\n.mt-3 {\n  margin-top: 16px;\n}\n.items-center {\n  align-items: center;\n}\n.items-end {\n  align-items: flex-end;\n}\n.items-baseline {\n  align-items: baseline;\n}\n\n.my-5 {\n  margin-top: 48px;\n  margin-bottom: 48px;\n}\n.my-4 {\n  margin-top: 24px;\n  margin-bottom: 24px;\n}\n.my-3 {\n  margin-top: 16px;\n  margin-bottom: 16px;\n}\n.pt-3 {\n  padding-top: 12px;\n}\n.px-3 {\n  padding-left: 12px;\n  padding-right: 12px;\n}\n.pt-2 {\n  padding-top: 8px;\n}\n.px-2 {\n  padding-left: 8px;\n  padding-right: 8px;\n}\n.pt-1 {\n  padding-top: 4px;\n}\n.px-1 {\n  padding-left: 4px;\n  padding-right: 4px;\n}\n.pb-2 {\n  padding-bottom: 8px;\n}\n.justify-end {\n  justify-content: flex-end;\n}\n.w-auto {\n  width: auto;\n}\n', IMMERSIVE_TRANSLATE_POPUP_HTML: '<style>\n  html {\n    font-size: 17px;\n  }\n  .immersive-translate-popup-container {\n    position: fixed;\n    top: 100px;\n    right: 8px;\n    padding: 0;\n    z-index: 999999;\n  }\n  .immersive-translate-popup-btn {\n    background-color: #ea4c89;\n    font-size: 18px;\n    width: 36px;\n    height: 36px;\n    border-radius: 9999999px;\n    border: 1px solid #ccc;\n  }\n  .immersive-translate-popup-btn > svg {\n    background-color: #ea4c89;\n  }\n  #mount#mount {\n    display: none;\n    min-width: 250px;\n    height: auto;\n    border: 1px solid #ccc;\n    border-radius: 5px;\n    --font-size: 17px;\n    font-size: 17px;\n  }\n</style>\n\n<div\n  id="immersive-translate-popup-container"\n  class="immersive-translate-popup-container"\n>\n  <button\n    id="immersive-translate-popup-btn"\n    class="immersive-translate-popup-btn"\n  >\n    <svg\n      xmlns="http://www.w3.org/2000/svg"\n      viewBox="0 0 24 24"\n      width="24"\n      height="24"\n    >\n      <path fill="none" d="M0 0h24v24H0z" />\n      <path\n        d="M5 15v2a2 2 0 0 0 1.85 1.995L7 19h3v2H7a4 4 0 0 1-4-4v-2h2zm13-5l4.4 11h-2.155l-1.201-3h-4.09l-1.199 3h-2.154L16 10h2zm-1 2.885L15.753 16h2.492L17 12.885zM8 2v2h4v7H8v3H6v-3H2V4h4V2h2zm9 1a4 4 0 0 1 4 4v2h-2V7a2 2 0 0 0-2-2h-3V3h3zM6 6H4v3h2V6zm4 0H8v3h2V6z"\n        fill="rgba(255,255,255,1)"\n      />\n    </svg>\n  </button>\n  <div class="immersive-translate-popup-mount" id="mount"></div>\n</div>\n', IMMERSIVE_TRANSLATE_POPUP_JS: 'const immersivePopupRoot = document.getElementById("immersive-translate-popup");\nconst shadowRoot = immersivePopupRoot.shadowRoot;\n\nconst root = shadowRoot.getElementById("immersive-translate-popup-container");\n\nconst btn = root.querySelector("#immersive-translate-popup-btn");\n\n// btn.addEventListener("click", handleButtonClick);\n\nconst mountContainer = root.querySelector("#mount");\n\nfunction showButton() {\n  // hidden mount container, and show btn\n  mountContainer.style.display = "none";\n  btn.style.display = "block";\n}\n\ndocument.addEventListener("click", (e) => {\n  if (e.target.id !== "immersive-translate-popup") {\n    showButton();\n  }\n});\n', OPTIONS_URL: "https://immersive-translate.owenyoung.com/options/", MOCK: "0", DEBUG: "0", IMMERSIVE_TRANSLATE_USERSCRIPT: "1" };
  ...
  // https://esm.sh/v103/n-gram@2.0.2/deno/n-gram.js
  var c = o(2);
  var f = o(3);
  function o(r2) {
    ...
    function s8(t4) {
      ...
      if (t4 == null)
        return e3;
      let i5 = typeof t4.slice == "function" ? t4 : String(t4), n3 = i5.length - r2 + 1;
      if (n3 < 1)
        return e3;
      for (; n3--; )
        e3[n3] = i5.slice(n3, n3 + r2);
      return e3;
    }
  }

  // https://esm.sh/v103/collapse-white-space@2.1.0/deno/collapse-white-space.js
  var l = /\s+/g;
  var a = /[\t\n\v\f\r ]+/g;
  function i(r2, e3) {
  ...
  function g(r2) {
    return e3;
    function e3(n3, t4, c5) {
      return t4 === 0 || t4 + n3.length === c5.length ? "" : r2(n3);
    }
  }

  // https://esm.sh/v103/trigram-utils@2.0.1/deno/trigram-utils.js
  ...
  // https://esm.sh/v103/franc-min@6.1.0/deno/franc-min.js
  ...
  for (t in s2)
    if (r.call(s2, t)) {
      ...
      for (a7 in n3)
        if (r.call(n3, a7)) {
          let e3 = n3[a7].split("|"), o6 = {}, i5 = e3.length;
          for (; i5--; )
            o6[e3[i5]] = i5;
          l3[t][a7] = o6;
        }
  ...
  function c2(n3, a7 = {}) {
    let e3 = [...a7.whitelist || [], ...a7.only || []], o6 = [...a7.blacklist || [], ...a7.ignore || []], i5 = a7.minLength !== null && a7.minLength !== void 0 ? a7.minLength : p;
    if (!n3 || n3.length < i5)
      return d();
    n3 = n3.slice(0, y);
    let u6 = z(n3, k);
    return !u6[0] || !(u6[0] in l3) ? !u6[0] || u6[1] === 0 || !g2(u6[0], e3, o6) ? d() : h(u6[0]) : w(n3, j(m(n3), l3[u6[0]], e3, o6));
  }
  function w(n3, a7) {
    let e3 = a7[0][1], o6 = n3.length * m2 - e3, i5 = -1;
    for (; ++i5 < a7.length; )
      a7[i5][1] = 1 - (a7[i5][1] - e3) / o6 || 0;
    return a7;
  }
  function z(n3, a7) {
    let e3 = -1, o6, i5;
  ...
  function j(n3, a7, e3, o6) {
    a7 = f3(a7, e3, o6);
    let i5 = [], u6;
    if (a7)
      for (u6 in a7)
        r.call(a7, u6) && i5.push([u6, v(n3, a7[u6])]);
    return i5.length === 0 ? d() : i5.sort(F);
  }
  function v(n3, a7) {
    let e3 = 0, o6 = -1;
    for (; ++o6 < n3.length; ) {
      let i5 = n3[o6], u6 = m2;
      i5[0] in a7 && (u6 = i5[1] - a7[i5[0]] - 1, u6 < 0 && (u6 = -u6)), e3 += u6;
    }
    return e3;
  }
  function f3(n3, a7, e3) {
    if (a7.length === 0 && e3.length === 0)
      return n3;
    let o6 = {}, i5;
    for (i5 in n3)
      g2(i5, a7, e3) && (o6[i5] = n3[i5]);
    return o6;
  }
  function g2(n3, a7, e3) {
    return a7.length === 0 && e3.length === 0 ? true : (a7.length === 0 || a7.includes(n3)) && !e3.includes(n3);
  }
  function d() {
    return h("und");
  }
  ...
  function openOptionsPage() {
    const env4 = getEnv();
    const optionsUrl = env4.OPTIONS_URL;
    if (optionsUrl) {
  ...
  function duplicatedElements(root2, array, rule) {
    ...
    for (let i5 = 0; i5 < array.length; i5++) {
      const a7 = array[i5].element;
      for (let j6 = i5 + 1; j6 < array.length; j6++) {
        const b5 = array[j6].element;
        if (a7.contains(b5)) {
          array.splice(j6, 1);
          j6--;
        } else if (b5.contains(a7)) {
          array.splice(i5, 1);
          i5--;
          break;
        } else if (a7 === b5) {
  ...
  function getLastHTMLElement(elements) {
    for (let i5 = elements.length - 1; i5 >= 0; i5--) {
      const element = elements[i5].element || elements[i5];
  ...
  function getMainText(root2) {
    ...
    let text = "";
    if (main3) {
      text = trimText(main3.innerText || main3.textContent || "");
    }
    if (text.length >= 10) {
      return text;
    }
    ...
    if (article.length > 0) {
      for (const a7 of article) {
        text = trimText(a7.innerText || a7.textContent || "");
      }
    }
    if (text.length >= 10) {
      return text;
  ...
  function removeFromArray(item, array) {
    ...
    return array.filter((i5) => !item.includes(i5));
  }
  ...
  function deadline(p8, delay2) {
    const d5 = deferred();
    const t4 = setTimeout(() => d5.reject(new DeadlineError()), delay2);
    return Promise.race([p8, d5]).finally(() => clearTimeout(t4));
  }
  ...
  var MuxAsyncIterator = class {
    ...
    async *iterate() {
      while (this.#iteratorCount > 0) {
        await this.#signal;
        for (let i5 = 0; i5 < this.#yields.length; i5++) {
          const { iterator, value } = this.#yields[i5];
          yield value;
  ...
  function ee(e3, t4, _2) {
    var r2, l7, o6, s8 = {};
    for (o6 in t4)
      o6 == "key" ? r2 = t4[o6] : o6 == "ref" ? l7 = t4[o6] : s8[o6] = t4[o6];
    if (arguments.length > 2 && (s8.children = arguments.length > 3 ? P.call(arguments, 2) : _2), typeof e3 == "function" && e3.defaultProps != null)
      for (o6 in e3.defaultProps)
        s8[o6] === void 0 && (s8[o6] = e3.defaultProps[o6]);
    return w2(e3, s8, r2, l7, null);
  }
  function w2(e3, t4, _2, r2, l7) {
    var o6 = { type: e3, props: t4, key: _2, ref: r2, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: l7 ?? ++$ };
    return l7 == null && d2.vnode != null && d2.vnode(o6), o6;
  }
  function L(e3) {
    return e3.children;
  }
  ...
  function M(e3) {
    (!e3.__d && (e3.__d = true) && S.push(e3) && !D2.__r++ || F2 !== d2.debounceRendering) && ((F2 = d2.debounceRendering) || setTimeout)(D2);
  }
  function D2() {
    for (var e3; D2.__r = S.length; )
      e3 = S.sort(function(t4, _2) {
        ...
        var _2, r2, l7, o6, s8, f6;
        t4.__d && (s8 = (o6 = (_2 = t4).__v).__e, (f6 = _2.__P) && (r2 = [], (l7 = k2({}, o6)).__v = o6.__v + 1, W(f6, o6, l7, _2.__n, f6.ownerSVGElement !== void 0, o6.__h != null ? [s8] : null, r2, s8 ?? C(o6), o6.__h), K(r2, o6), o6.__e != s8 && z2(o6)));
      });
  }
  function G(e3, t4, _2, r2, l7, o6, s8, f6, p8, a7) {
    var n3, h4, c5, i5, u6, b5, v5, y5 = r2 && r2.__k || V, g7 = y5.length;
    for (_2.__k = [], n3 = 0; n3 < t4.length; n3++)
      if ((i5 = _2.__k[n3] = (i5 = t4[n3]) == null || typeof i5 == "boolean" ? null : typeof i5 == "string" || typeof i5 == "number" || typeof i5 == "bigint" ? w2(null, i5, null, null, i5) : Array.isArray(i5) ? w2(L, { children: i5 }, null, null, null) : i5.__b > 0 ? w2(i5.type, i5.props, i5.key, i5.ref ? i5.ref : null, i5.__v) : i5) != null) {
        if (i5.__ = _2, i5.__b = _2.__b + 1, (c5 = y5[n3]) === null || c5 && i5.key == c5.key && i5.type === c5.type)
          y5[n3] = void 0;
        else
          for (h4 = 0; h4 < g7; h4++) {
            if ((c5 = y5[h4]) && i5.key == c5.key && i5.type === c5.type) {
              y5[h4] = void 0;
              break;
            }
            c5 = null;
          }
        W(e3, i5, c5 = c5 || T, l7, o6, s8, f6, p8, a7), u6 = i5.__e, (h4 = i5.ref) && c5.ref != h4 && (v5 || (v5 = []), c5.ref && v5.push(c5.ref, null, i5), v5.push(h4, i5.__c || u6, i5)), u6 != null ? (b5 == null && (b5 = u6), typeof i5.type == "function" && i5.__k === c5.__k ? i5.__d = p8 = q(i5, p8, e3) : p8 = J(e3, i5, c5, y5, u6, p8), typeof _2.type == "function" && (_2.__d = p8)) : p8 && c5.__e == p8 && p8.parentNode != e3 && (p8 = C(c5));
      }
    for (_2.__e = b5, n3 = g7; n3--; )
      y5[n3] != null && (typeof _2.type == "function" && y5[n3].__e != null && y5[n3].__e == _2.__d && (_2.__d = C(r2, n3 + 1)), X(y5[n3], y5[n3]));
    if (v5)
      for (n3 = 0; n3 < v5.length; n3++)
        Q(v5[n3], v5[++n3], v5[++n3]);
  }
  function q(e3, t4, _2) {
    for (var r2, l7 = e3.__k, o6 = 0; l7 && o6 < l7.length; o6++)
      (r2 = l7[o6]) && (r2.__ = e3, t4 = typeof r2.type == "function" ? q(r2, t4, _2) : J(_2, r2, r2, l7, r2.__e, t4));
    return t4;
  }
  function J(e3, t4, _2, r2, l7, o6) {
    var s8, f6, p8;
    if (t4.__d !== void 0)
      s8 = t4.__d, t4.__d = void 0;
    else if (_2 == null || l7 != o6 || l7.parentNode == null)
      e:
        if (o6 == null || o6.parentNode !== e3)
          e3.appendChild(l7), s8 = null;
        else {
          for (f6 = o6, p8 = 0; (f6 = f6.nextSibling) && p8 < r2.length; p8 += 2)
            if (f6 == l7)
              break e;
          e3.insertBefore(l7, o6), s8 = o6;
        }
    return s8 !== void 0 ? s8 : l7.nextSibling;
  }
  function _e(e3, t4, _2, r2, l7) {
    var o6;
    for (o6 in _2)
      o6 === "children" || o6 === "key" || o6 in t4 || N(e3, o6, null, _2[o6], r2);
    for (o6 in t4)
      l7 && typeof t4[o6] != "function" || o6 === "children" || o6 === "key" || o6 === "value" || o6 === "checked" || _2[o6] === t4[o6] || N(e3, o6, t4[o6], _2[o6], r2);
  }
  function I(e3, t4, _2) {
    t4[0] === "-" ? e3.setProperty(t4, _2) : e3[t4] = _2 == null ? "" : typeof _2 != "number" || Z.test(t4) ? _2 : _2 + "px";
  }
  function N(e3, t4, _2, r2, l7) {
    var o6;
    e:
      if (t4 === "style")
        if (typeof _2 == "string")
          ...
          if (_2)
            for (t4 in _2)
              r2 && _2[t4] === r2[t4] || I(e3.style, t4, _2[t4]);
        }
      else if (t4[0] === "o" && t4[1] === "n")
        o6 = t4 !== (t4 = t4.replace(/Capture$/, "")), t4 = t4.toLowerCase() in e3 ? t4.toLowerCase().slice(2) : t4.slice(2), e3.l || (e3.l = {}), e3.l[t4 + o6] = _2, _2 ? r2 || e3.addEventListener(t4, o6 ? R : O, o6) : e3.removeEventListener(t4, o6 ? R : O, o6);
  ...
  function O(e3) {
    this.l[e3.type + false](d2.event ? d2.event(e3) : e3);
  }
  function R(e3) {
    this.l[e3.type + true](d2.event ? d2.event(e3) : e3);
  }
  function W(e3, t4, _2, r2, l7, o6, s8, f6, p8) {
    var a7, n3, h4, c5, i5, u6, b5, v5, y5, g7, x6, H6, E3, m6 = t4.type;
    if (t4.constructor !== void 0)
      return null;
    _2.__h != null && (p8 = _2.__h, f6 = t4.__e = _2.__e, t4.__h = null, o6 = [f6]), (a7 = d2.__b) && a7(t4);
    try {
      e:
        if (typeof m6 == "function") {
          if (v5 = t4.props, y5 = (a7 = m6.contextType) && r2[a7.__c], g7 = a7 ? y5 ? y5.props.value : a7.__ : r2, _2.__c ? b5 = (n3 = t4.__c = _2.__c).__ = n3.__E : ("prototype" in m6 && m6.prototype.render ? t4.__c = n3 = new m6(v5, g7) : (t4.__c = n3 = new U(v5, g7), n3.constructor = m6, n3.render = oe), y5 && y5.sub(n3), n3.props = v5, n3.state || (n3.state = {}), n3.context = g7, n3.__n = r2, h4 = n3.__d = true, n3.__h = []), n3.__s == null && (n3.__s = n3.state), m6.getDerivedStateFromProps != null && (n3.__s == n3.state && (n3.__s = k2({}, n3.__s)), k2(n3.__s, m6.getDerivedStateFromProps(v5, n3.__s))), c5 = n3.props, i5 = n3.state, h4)
            ...
            if (m6.getDerivedStateFromProps == null && v5 !== c5 && n3.componentWillReceiveProps != null && n3.componentWillReceiveProps(v5, g7), !n3.__e && n3.shouldComponentUpdate != null && n3.shouldComponentUpdate(v5, n3.__s, g7) === false || t4.__v === _2.__v) {
              n3.props = v5, n3.state = n3.__s, t4.__v !== _2.__v && (n3.__d = false), n3.__v = t4, t4.__e = _2.__e, t4.__k = _2.__k, t4.__k.forEach(function(A4) {
                A4 && (A4.__ = t4);
              }), n3.__h.length && s8.push(n3);
              break e;
            }
            n3.componentWillUpdate != null && n3.componentWillUpdate(v5, n3.__s, g7), n3.componentDidUpdate != null && n3.__h.push(function() {
              n3.componentDidUpdate(c5, i5, u6);
            });
          }
          if (n3.context = g7, n3.props = v5, n3.__v = t4, n3.__P = e3, x6 = d2.__r, H6 = 0, "prototype" in m6 && m6.prototype.render)
            n3.state = n3.__s, n3.__d = false, x6 && x6(t4), a7 = n3.render(n3.props, n3.state, n3.context);
          else
            do
              n3.__d = false, x6 && x6(t4), a7 = n3.render(n3.props, n3.state, n3.context), n3.state = n3.__s;
            while (n3.__d && ++H6 < 25);
          n3.state = n3.__s, n3.getChildContext != null && (r2 = k2(k2({}, r2), n3.getChildContext())), h4 || n3.getSnapshotBeforeUpdate == null || (u6 = n3.getSnapshotBeforeUpdate(c5, i5)), E3 = a7 != null && a7.type === L && a7.key == null ? a7.props.children : a7, G(e3, Array.isArray(E3) ? E3 : [E3], t4, _2, r2, l7, o6, s8, f6, p8), n3.base = t4.__e, t4.__h = null, n3.__h.length && s8.push(n3), b5 && (n3.__E = n3.__ = null), n3.__e = false;
        } else
          o6 == null && t4.__v === _2.__v ? (t4.__k = _2.__k, t4.__e = _2.__e) : t4.__e = ne(_2.__e, t4, _2, r2, l7, o6, s8, p8);
      (a7 = d2.diffed) && a7(t4);
    } catch (A4) {
      t4.__v = null, (p8 || o6 != null) && (t4.__e = f6, t4.__h = !!p8, o6[o6.indexOf(f6)] = null), d2.__e(A4, t4, _2);
    }
  }
  function K(e3, t4) {
    d2.__c && d2.__c(t4, e3), e3.some(function(_2) {
      try {
  ...
  function ne(e3, t4, _2, r2, l7, o6, s8, f6) {
    var p8, a7, n3, h4 = _2.props, c5 = t4.props, i5 = t4.type, u6 = 0;
    if (i5 === "svg" && (l7 = true), o6 != null) {
      for (; u6 < o6.length; u6++)
        if ((p8 = o6[u6]) && "setAttribute" in p8 == !!i5 && (i5 ? p8.localName === i5 : p8.nodeType === 3)) {
          e3 = p8, o6[u6] = null;
          break;
        }
    }
    if (e3 == null) {
      ...
      e3 = l7 ? document.createElementNS("http://www.w3.org/2000/svg", i5) : document.createElement(i5, c5.is && c5), o6 = null, f6 = false;
    }
    if (i5 === null)
      h4 === c5 || f6 && e3.data === c5 || (e3.data = c5);
    else {
      if (o6 = o6 && P.call(e3.childNodes), a7 = (h4 = _2.props || T).dangerouslySetInnerHTML, n3 = c5.dangerouslySetInnerHTML, !f6) {
        if (o6 != null)
          for (h4 = {}, u6 = 0; u6 < e3.attributes.length; u6++)
            h4[e3.attributes[u6].name] = e3.attributes[u6].value;
        (n3 || a7) && (n3 && (a7 && n3.__html == a7.__html || n3.__html === e3.innerHTML) || (e3.innerHTML = n3 && n3.__html || ""));
      }
      if (_e(e3, c5, h4, l7, f6), n3)
        t4.__k = [];
      else if (u6 = t4.props.children, G(e3, Array.isArray(u6) ? u6 : [u6], t4, _2, r2, l7 && i5 !== "foreignObject", o6, s8, o6 ? o6[0] : _2.__k && C(_2, 0), f6), o6 != null)
        for (u6 = o6.length; u6--; )
          o6[u6] != null && j2(o6[u6]);
      f6 || ("value" in c5 && (u6 = c5.value) !== void 0 && (u6 !== e3.value || i5 === "progress" && !u6 || i5 === "option" && u6 !== h4.value) && N(e3, "value", u6, h4.value, false), "checked" in c5 && (u6 = c5.checked) !== void 0 && u6 !== e3.checked && N(e3, "checked", u6, h4.checked, false));
    }
    return e3;
  }
  function Q(e3, t4, _2) {
  ...
  function X(e3, t4, _2) {
    var r2, l7;
    if (d2.unmount && d2.unmount(e3), (r2 = e3.ref) && (r2.current && r2.current !== e3.__e || Q(r2, null, t4)), (r2 = e3.__c) != null) {
    ...
    if (r2 = e3.__k)
      for (l7 = 0; l7 < r2.length; l7++)
        r2[l7] && X(r2[l7], t4, typeof e3.type != "function");
  ...
  function re(e3, t4, _2) {
    var r2, l7, o6;
    d2.__ && d2.__(e3, t4), l7 = (r2 = typeof _2 == "function") ? null : _2 && _2.__k || t4.__k, o6 = [], W(t4, e3 = (!r2 && _2 || t4).__k = ee(L, null, [e3]), l7 || T, T, t4.ownerSVGElement !== void 0, !r2 && _2 ? [_2] : l7 ? null : t4.firstChild ? P.call(t4.childNodes) : null, o6, !r2 && _2 ? _2 : l7 ? l7.__e : t4.firstChild, r2), K(o6, e3);
  }
  function ce(e3, t4) {
    var _2 = { __c: t4 = "__cC" + B++, __: e3, Consumer: function(r2, l7) {
      return r2.children(l7);
    }, Provider: function(r2) {
      var l7, o6;
      return this.getChildContext || (l7 = [], (o6 = {})[t4] = this, this.getChildContext = function() {
        return o6;
      }, this.shouldComponentUpdate = function(s8) {
        this.props.value !== s8.value && l7.some(M);
      }, this.sub = function(s8) {
        l7.push(s8);
        var f6 = s8.componentWillUnmount;
        s8.componentWillUnmount = function() {
          l7.splice(l7.indexOf(s8), 1), f6 && f6.call(s8);
        };
      }), r2.children;
    } };
    return _2.Provider.__ = _2.Consumer.contextType = _2;
  }
  P = V.slice, d2 = { __e: function(e3, t4, _2, r2) {
    for (var l7, o6, s8; t4 = t4.__; )
      if ((l7 = t4.__c) && !l7.__)
        try {
          if ((o6 = l7.constructor) && o6.getDerivedStateFromError != null && (l7.setState(o6.getDerivedStateFromError(e3)), s8 = l7.__d), l7.componentDidCatch != null && (l7.componentDidCatch(e3, r2 || {}), s8 = l7.__d), s8)
            return l7.__E = l7;
        } catch (f6) {
          e3 = f6;
        }
    ...
    var _2;
    _2 = this.__s != null && this.__s !== this.state ? this.__s : this.__s = k2({}, this.state), typeof e3 == "function" && (e3 = e3(k2({}, _2), this.props)), e3 && k2(_2, e3), e3 != null && this.__v && (t4 && this.__h.push(t4), M(this));
  ...
  var A = d2.unmount;
  function a3(_2, t4) {
    d2.__h && d2.__h(n, _2, f4 || t4), f4 = 0;
    var u6 = n.__H || (n.__H = { __: [], __h: [] });
    return _2 >= u6.__.length && u6.__.push({ __V: l4 }), u6.__[_2];
  }
  function P2(_2) {
    return f4 = 1, B2(D3, _2);
  }
  function B2(_2, t4, u6) {
    var o6 = a3(i2++, 2);
    if (o6.t = _2, !o6.__c && (o6.__ = [u6 ? u6(t4) : D3(void 0, t4), function(v5) {
      var s8 = o6.__N ? o6.__N[0] : o6.__[0], h4 = o6.t(s8, v5);
      s8 !== h4 && (o6.__N = [h4, o6.__[1]], o6.__c.setState({}));
    }], o6.__c = n, !n.u)) {
      n.u = true;
      var r2 = n.shouldComponentUpdate;
      n.shouldComponentUpdate = function(v5, s8, h4) {
        if (!o6.__c.__H)
          return true;
        var y5 = o6.__c.__H.__.filter(function(c5) {
          return c5.__c;
        });
        if (y5.every(function(c5) {
          return !c5.__N;
        }))
          return !r2 || r2.call(this, v5, s8, h4);
        var E3 = false;
        return y5.forEach(function(c5) {
          if (c5.__N) {
            var k6 = c5.__[0];
            c5.__ = c5.__N, c5.__N = void 0, k6 !== c5.__[0] && (E3 = true);
          }
        }), !!E3 && (!r2 || r2.call(this, v5, s8, h4));
      };
    }
    return o6.__N || o6.__;
  }
  function j3(_2, t4) {
    var u6 = a3(i2++, 3);
    !d2.__s && H(u6.__H, t4) && (u6.__ = _2, u6.i = t4, n.__H.__h.push(u6));
  }
  function w3(_2) {
  ...
  function x(_2, t4) {
    var u6 = a3(i2++, 7);
    return H(u6.__H, t4) ? (u6.__V = _2(), u6.i = t4, u6.__h = _2, u6.__V) : u6.__;
  }
  function L2(_2, t4) {
  ...
  function M2(_2) {
    var t4 = n.context[_2.__c], u6 = a3(i2++, 9);
    return u6.c = _2, t4 ? (u6.__ == null && (u6.__ = true, t4.sub(n)), t4.props.value) : _2.__;
  }
  function R2() {
  ...
  d2.__b = function(_2) {
    ...
    g3 && g3(_2), i2 = 0;
    var t4 = (n = _2.__c).__H;
    t4 && (d3 === n ? (t4.__h = [], n.__h = [], t4.__.forEach(function(u6) {
      u6.__N && (u6.__ = u6.__N), u6.__V = l4, u6.__N = u6.i = void 0;
    })) : (t4.__h.forEach(m3), t4.__h.forEach(p2), t4.__h = [])), d3 = n;
  }, d2.diffed = function(_2) {
    b && b(_2);
    var t4 = _2.__c;
    t4 && t4.__H && (t4.__H.__h.length && (q2.push(t4) !== 1 && N2 === d2.requestAnimationFrame || ((N2 = d2.requestAnimationFrame) || S2)(R2)), t4.__H.__.forEach(function(u6) {
      u6.i && (u6.__H = u6.i), u6.__V !== l4 && (u6.__ = u6.__V), u6.i = void 0, u6.__V = l4;
    })), d3 = n = null;
  }, d2.__c = function(_2, t4) {
    t4.some(function(u6) {
      try {
        u6.__h.forEach(m3), u6.__h = u6.__h.filter(function(o6) {
          return !o6.__ || p2(o6);
        });
      } catch (o6) {
        t4.some(function(r2) {
    ...
    A && A(_2);
    var t4, u6 = _2.__c;
    u6 && u6.__H && (u6.__H.__.forEach(function(o6) {
      try {
        m3(o6);
      } catch (r2) {
        t4 = r2;
      }
    }), u6.__H = void 0, t4 && d2.__e(t4, u6.__v));
  };
  var F3 = typeof requestAnimationFrame == "function";
  function S2(_2) {
    var t4, u6 = function() {
      clearTimeout(o6), F3 && cancelAnimationFrame(t4), setTimeout(_2);
    }, o6 = setTimeout(u6, 100);
    F3 && (t4 = requestAnimationFrame(u6));
  }
  function m3(_2) {
    var t4 = n, u6 = _2.__c;
    typeof u6 == "function" && (_2.__c = void 0, u6()), n = t4;
  }
  function p2(_2) {
    var t4 = n;
    _2.__c = _2.__(), n = t4;
  ...
  function H(_2, t4) {
    return !_2 || _2.length !== t4.length || t4.some(function(u6, o6) {
      return u6 !== _2[o6];
    });
  }
  function D3(_2, t4) {
  ...
  function m4({ limit: i5, interval: s8, strict: f6 }) {
    if (!Number.isFinite(i5))
      throw new TypeError("Expected `limit` to be a finite number");
    if (!Number.isFinite(s8))
      throw new TypeError("Expected `interval` to be a finite number");
    let r2 = /* @__PURE__ */ new Map(), u6 = 0, c5 = 0;
    function p8() {
      let e3 = Date.now();
      return e3 - u6 > s8 ? (c5 = 1, u6 = e3, 0) : (c5 < i5 ? c5++ : (u6 += s8, c5 = 1), u6 - e3);
    }
    let n3 = [];
    function h4() {
      let e3 = Date.now();
    ...
    return (e3) => {
      let t4 = function(...o6) {
        if (!t4.isEnabled)
          return (async () => e3.apply(this, o6))();
        let l7;
        return new Promise((d5, b5) => {
          l7 = setTimeout(() => {
            d5(e3.apply(this, o6)), r2.delete(l7);
          }, w7()), r2.set(l7, b5);
        });
      };
      return t4.abort = () => {
        for (let o6 of r2.keys())
          clearTimeout(o6), r2.get(o6)(new a4());
  ...
  function V3(t4) {
    for (var e3 = 9, r2 = t4.length; r2--; )
      e3 = Math.imul(e3 ^ t4.charCodeAt(r2), 1597334677);
    return "#" + ((e3 ^ e3 >>> 9) >>> 0).toString(36);
  }
  function kt(t4, e3 = "@media ") {
    return e3 + x2(t4).map((r2) => (typeof r2 == "string" && (r2 = { min: r2 }), r2.raw || Object.keys(r2).map((n3) => `(${n3}-width:${r2[n3]})`).join(" and "))).join(",");
  }
  function x2(t4 = []) {
  ...
  function at({ n: t4, i: e3, v: r2 = [] }, n3, i5, l7) {
    for (let a7 of (t4 && (t4 = lt({ n: t4, i: e3, v: r2 })), l7 = [...x2(l7)], r2)) {
      let s8 = n3.theme("screens", a7);
      for (let u6 of x2(s8 && kt(s8) || n3.v(a7))) {
        var o6;
        l7.push(u6), i5 |= s8 ? 67108864 | X2(u6) : a7 == "dark" ? 1073741824 : u6[0] == "@" ? X2(u6) : (o6 = u6, 1 << ~(/:([a-z-]+)/.test(o6) && ~qt.indexOf(RegExp.$1.slice(2, 7)) || -18));
      }
    }
    return { n: t4, p: i5, r: l7, i: e3 };
  }
  var ut = /* @__PURE__ */ new Map();
  function tt(t4) {
    if (t4.d) {
      let e3 = [], r2 = Y2(t4.r.reduce((n3, i5) => i5[0] == "@" ? (e3.push(i5), n3) : i5 ? Y2(n3, (l7) => Y2(i5, (o6) => {
        let a7 = /(:merge\(.+?\))(:[a-z-]+|\\[.+])/.exec(o6);
        if (a7) {
          let s8 = l7.indexOf(a7[1]);
          return ~s8 ? l7.slice(0, s8) + a7[0] + l7.slice(s8 + a7[1].length) : Z2(l7, o6);
        }
        return Z2(o6, l7);
      })) : n3, "&"), (n3) => Z2(n3, t4.n ? "." + W2(t4.n) : ""));
      return r2 && e3.push(r2.replace(/:merge\((.+?)\)/g, "$1")), e3.reduceRight((n3, i5) => i5 + "{" + n3 + "}", t4.d);
    }
  }
  function Y2(t4, e3) {
    return t4.replace(/ *((?:\(.+?\)|\[.+?\]|[^,])+) *(,|$)/g, (r2, n3, i5) => e3(n3) + i5);
  }
  function Z2(t4, e3) {
  ...
  function St(t4, e3) {
    for (var r2 = 0, n3 = t4.length; r2 < n3; ) {
      let i5 = n3 + r2 >> 1;
      0 >= Mt(t4[i5], e3) ? r2 = i5 + 1 : n3 = i5;
    }
    return n3;
  }
  function Mt(t4, e3) {
    let r2 = t4.p & w4.o;
    return r2 == (e3.p & w4.o) && (r2 == w4.b || r2 == w4.o) ? 0 : t4.p - e3.p || t4.o - e3.o || Dt.compare(t4.n, e3.n);
  }
  function H2(t4, e3) {
  ...
  function T2(t4, e3 = {}) {
    if (typeof t4 == "function")
      return t4(e3);
    let { opacityValue: r2 = "1", opacityVariable: n3 } = e3, i5 = n3 ? `var(${n3})` : r2;
    if (t4.includes("<alpha-value>"))
      return t4.replace("<alpha-value>", i5);
    if (t4[0] == "#" && (t4.length == 4 || t4.length == 7)) {
      let l7 = (t4.length - 1) / 3, o6 = [17, 1, 0.062272][l7 - 1];
      return `rgba(${[H2(t4.substr(1, l7), o6), H2(t4.substr(1 + l7, l7), o6), H2(t4.substr(1 + 2 * l7, l7), o6), i5]})`;
    }
    return i5 == "1" ? t4 : i5 == "0" ? "#0000" : t4.replace(/^(rgb|hsl)(\([^)]+)\)$/, `$1a$2,${i5})`);
  }
  function ct(t4, e3, r2, n3, i5 = []) {
    return function l7(o6, { n: a7, p: s8, r: u6 = [], i: f6 }, c5) {
      let p8 = [], d5 = "", v5 = 0, g7 = 0;
      for (let h4 in o6 || {}) {
        var y5, A4;
        let b5 = o6[h4];
        if (h4[0] == "@") {
          if (!b5)
            continue;
          if (h4[1] == "a") {
            p8.push(...ht(a7, s8, N3("" + b5), c5, s8, u6, f6, true));
            continue;
          }
          if (h4[1] == "l") {
            for (let m6 of x2(b5))
              p8.push(...l7(m6, { n: a7, p: (y5 = w4[h4[7]], s8 & ~w4.o | y5), r: u6, i: f6 }, c5));
            continue;
          }
          if (h4[1] == "i") {
            p8.push(...x2(b5).map((m6) => ({ p: -1, o: 0, r: [], d: h4 + " " + m6 })));
            continue;
          }
          if (h4[1] == "k") {
            p8.push({ p: w4.d, o: 0, r: [h4], d: l7(b5, { p: w4.d }, c5).map(tt).join("") });
            continue;
          }
          if (h4[1] == "f") {
            p8.push(...x2(b5).map((m6) => ({ p: w4.d, o: 0, r: [h4], d: l7(m6, { p: w4.d }, c5).map(tt).join("") })));
            continue;
          }
        }
        if (typeof b5 != "object" || Array.isArray(b5))
          h4 == "label" && b5 ? a7 = b5 + V3(JSON.stringify([s8, f6, o6])) : (b5 || b5 === 0) && (h4 = h4.replace(/[A-Z]/g, (m6) => "-" + m6.toLowerCase()), g7 += 1, v5 = Math.max(v5, (A4 = h4)[0] == "-" ? 0 : jt(A4) + (/^(?:(border-(?!w|c|sty)|[tlbr].{2,4}m?$|c.{7}$)|([fl].{5}l|g.{8}$|pl))/.test(A4) ? +!!RegExp.$1 || -!!RegExp.$2 : 0) + 1), d5 += (d5 ? ";" : "") + x2(b5).map((m6) => c5.s(h4, ft("" + m6, c5.theme) + (f6 ? " !important" : ""))).join(";"));
        else if (h4[0] == "@" || h4.includes("&")) {
          let m6 = s8;
          h4[0] == "@" && (h4 = h4.replace(/\bscreen\(([^)]+)\)/g, (C6, $4) => {
            let j6 = c5.theme("screens", $4);
            return j6 ? (m6 |= 67108864, kt(j6, "")) : C6;
          }), m6 |= X2(h4)), p8.push(...l7(b5, { n: a7, p: m6, r: [...u6, h4], i: f6 }, c5));
        } else
          p8.push(...l7(b5, { p: s8, r: [...u6, h4] }, c5));
      }
      return p8.unshift({ n: a7, p: s8, o: Math.max(0, 15 - g7) + 1.5 * Math.min(v5 || 15, 15), r: u6, d: d5 }), p8.sort(Mt);
    }(t4, at(e3, r2, n3, i5), r2);
  }
  function ft(t4, e3) {
    return t4.replace(/theme\((["'`])?(.+?)\1(?:\s*,\s*(["'`])?(.+?)\3)?\)/g, (r2, n3, i5, l7, o6) => {
      let a7 = e3(i5, o6);
      return typeof a7 == "function" && /color|fill|stroke/i.test(i5) ? T2(a7) : "" + a7;
    });
  }
  function pt(t4, e3) {
    let r2, n3 = [];
    for (let i5 of t4)
      i5.d && i5.n ? r2?.p == i5.p && "" + r2.r == "" + i5.r ? (r2.c = [r2.c, i5.c].filter(Boolean).join(" "), r2.d = r2.d + ";" + i5.d) : n3.push(r2 = { ...i5, n: i5.n && e3 }) : n3.push({ ...i5, n: i5.n && e3 });
    return n3;
  }
  function B3(t4, e3, r2 = w4.u, n3, i5) {
    let l7 = [];
    for (let o6 of t4)
      for (let a7 of function(s8, u6, f6, c5, p8) {
        var d5;
        s8 = { ...s8, i: s8.i || p8 };
        let v5 = function(g7, y5) {
          let A4 = ut.get(g7.n);
          return A4 ? A4(g7, y5) : y5.r(g7.n, g7.v[0] == "dark");
        }(s8, u6);
        return v5 ? typeof v5 == "string" ? ({ r: c5, p: f6 } = at(s8, u6, f6, c5), pt(B3(N3(v5), u6, f6, c5, s8.i), s8.n)) : Array.isArray(v5) ? v5.map((g7) => {
          var y5, A4;
          return { o: 0, ...g7, r: [...x2(c5), ...x2(g7.r)], p: (y5 = f6, A4 = (d5 = g7.p) != null ? d5 : f6, y5 & ~w4.o | A4) };
        }) : ct(v5, s8, u6, f6, c5) : [{ c: lt(s8), p: 0, o: 0, r: [] }];
      }(o6, e3, r2, n3, i5))
        l7.splice(St(l7, a7), 0, a7);
    return l7;
  }
  function ht(t4, e3, r2, n3, i5, l7, o6, a7) {
    return pt((a7 ? r2.flatMap((s8) => B3([s8], n3, i5, l7, o6)) : B3(r2, n3, i5, l7, o6)).map((s8) => s8.p & w4.o && (s8.n || e3 == w4.b) ? { ...s8, p: s8.p & ~w4.o | e3, o: 0 } : s8), t4);
  }
  function Ot(t4, e3, r2, n3) {
    var i5;
    return i5 = (l7, o6) => {
      let { n: a7, p: s8, r: u6, i: f6 } = at(l7, o6, e3);
      return r2 && ht(a7, e3, r2, o6, s8, u6, f6, n3);
    }, ut.set(t4, i5), t4;
  }
  function K2(t4, e3) {
    if (t4[t4.length - 1] != "(") {
      let r2 = [], n3 = false, i5 = false, l7 = "";
      for (let o6 of t4)
        if (!(o6 == "(" || /[~@]$/.test(o6))) {
          if (o6[0] == "!" && (o6 = o6.slice(1), n3 = !n3), o6.endsWith(":")) {
            r2[o6 == "dark:" ? "unshift" : "push"](o6.slice(0, -1));
            continue;
          }
          o6[0] == "-" && (o6 = o6.slice(1), i5 = !i5), o6.endsWith("-") && (o6 = o6.slice(0, -1)), o6 && o6 != "&" && (l7 += (l7 && "-") + o6);
        }
      l7 && (i5 && (l7 = "-" + l7), e3[0].push({ n: l7, v: r2.filter(Jt), i: n3 }));
    }
  }
  function Jt(t4, e3, r2) {
  ...
  function N3(t4) {
    let e3 = yt.get(t4);
    if (!e3) {
      let r2 = [], n3 = [[]], i5 = 0, l7 = 0, o6 = null, a7 = 0, s8 = (u6, f6 = 0) => {
        i5 != a7 && (r2.push(t4.slice(i5, a7 + f6)), u6 && K2(r2, n3)), i5 = a7 + 1;
      };
      for (; a7 < t4.length; a7++) {
        let u6 = t4[a7];
        if (l7)
          ...
          t4[a7 - 1] != "\\" && o6.test(t4.slice(a7)) && (o6 = null, i5 = a7 + RegExp.lastMatch.length);
        else if (u6 == "/" && t4[a7 - 1] != "\\" && (t4[a7 + 1] == "*" || t4[a7 + 1] == "/"))
          o6 = t4[a7 + 1] == "*" ? /^\*\// : /^[\r\n]/;
        else if (u6 == "(")
          s8(), r2.push(u6);
        else if (u6 == ":")
          ...
          s8(true);
          let f6 = r2.lastIndexOf("(");
          if (u6 == ")") {
            let c5 = r2[f6 - 1];
            if (/[~@]$/.test(c5)) {
              let p8 = n3.shift();
              r2.length = f6, K2([...r2, "#"], n3);
              let { v: d5 } = n3[0].pop();
              for (let v5 of p8)
                v5.v.splice(+(v5.v[0] == "dark") - +(d5[0] == "dark"), d5.length);
              K2([...r2, Ot(c5.length > 1 ? c5.slice(0, -1) + V3(JSON.stringify([c5, p8])) : c5 + "(" + st(p8) + ")", w4.a, p8, /@$/.test(c5))], n3);
            }
            f6 = r2.lastIndexOf("(", f6 - 1);
          }
          r2.length = f6 + 1;
        } else
          /[~@]/.test(u6) && t4[a7 + 1] == "(" && n3.unshift([]);
      }
      s8(true), yt.set(t4, e3 = n3[0]);
    }
    return e3;
  }
  function Ct(t4, e3, r2) {
    return e3.reduce((n3, i5, l7) => n3 + r2(i5) + t4[l7 + 1], t4[0]);
  }
  function G2(t4, e3) {
    return Array.isArray(t4) && Array.isArray(t4.raw) ? Ct(t4, e3, (r2) => Q2(r2).trim()) : e3.filter(Boolean).reduce((r2, n3) => r2 + Q2(n3), t4 ? Q2(t4) : "");
  }
  function Q2(t4) {
    let e3, r2 = "";
    if (t4 && typeof t4 == "object")
      if (Array.isArray(t4))
        (e3 = G2(t4[0], t4.slice(1))) && (r2 += " " + e3);
      else
        for (let n3 in t4)
          t4[n3] && (r2 += " " + n3);
    else
      t4 != null && typeof t4 != "boolean" && (r2 += " " + t4);
    return r2;
  }
  var ae = Et("@");
  var ue = Et("~");
  function Et(t4) {
    return new Proxy(function(r2, ...n3) {
      return e3("", r2, n3);
    }, { get: (r2, n3) => n3 in r2 ? r2[n3] : function(i5, ...l7) {
      return e3(n3, i5, l7);
    } });
    function e3(r2, n3, i5) {
      return st(N3(r2 + t4 + "(" + G2(n3, i5) + ")"));
    }
  }
  function U2(t4, e3) {
    return Array.isArray(t4) ? mt(Ct(t4, e3, (r2) => r2 != null && typeof r2 != "boolean" ? r2 : "")) : typeof t4 == "string" ? mt(t4) : [t4];
  }
  var Bt = / *(?:(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}))/g;
  function mt(t4) {
    let e3;
    ...
    let r2 = [{}], n3 = [r2[0]], i5 = [];
    for (; e3 = Bt.exec(t4); )
      e3[4] && (r2.shift(), i5.shift()), e3[3] ? (i5.unshift(e3[3]), r2.unshift({}), n3.push(i5.reduce((l7, o6) => ({ [o6]: l7 }), r2[0]))) : e3[4] || (r2[0][e3[1]] && (r2.unshift({}), n3.push(i5.reduce((l7, o6) => ({ [o6]: l7 }), r2[0]))), r2[0][e3[1]] = e3[2]);
    return n3;
  }
  function dt(t4, ...e3) {
    var r2, n3;
    let i5 = U2(t4, e3), l7 = (((r2 = i5.find((o6) => o6.label)) == null ? void 0 : r2.label) || "css") + V3(JSON.stringify(i5));
    return n3 = (o6, a7) => pt(i5.flatMap((s8) => ct(s8, o6, a7, w4.o)), l7), ut.set(l7, n3), l7;
  }
  var ce2 = new Proxy(function(t4, e3) {
    return bt("animation", t4, e3);
  }, { get: (t4, e3) => e3 in t4 ? t4[e3] : function(r2, n3) {
    return bt(e3, r2, n3);
  } });
  function bt(t4, e3, r2) {
    return { toString: () => dt({ label: t4, "@layer components": { ...typeof e3 == "object" ? e3 : { animation: e3 }, animationName: "" + r2 } }) };
  }
  var Ut = Symbol();
  var z3 = new Proxy(D4, { apply: (t4, e3, r2) => F4(r2[0]), get(t4, e3) {
    let r2 = F4[e3];
    return typeof r2 == "function" ? function() {
      return r2.apply(F4, arguments);
    } : r2;
  } });
  var xe = function t2(e3) {
    return new Proxy(function(r2, ...n3) {
      return xt(e3, "", r2, n3);
    }, { get: (r2, n3) => n3 === "bind" ? t2 : n3 in r2 ? r2[n3] : function(i5, ...l7) {
      return xt(e3, n3, i5, l7);
    } });
  }();
  function xt(t4, e3, r2, n3) {
    return { toString() {
      let i5 = U2(r2, n3), l7 = W2(e3 + V3(JSON.stringify([e3, i5])));
      return (typeof t4 == "function" ? t4 : z3)(dt({ [`@keyframes ${l7}`]: U2(r2, n3) })), l7;
    } };
  }
  ...
  var x3 = "#000";
  var b2 = "#fff";
  var u3 = { 50: "#f8fafc", 100: "#f1f5f9", 200: "#e2e8f0", 300: "#cbd5e1", 400: "#94a3b8", 500: "#64748b", 600: "#475569", 700: "#334155", 800: "#1e293b", 900: "#0f172a" };
  var g4 = { 50: "#f9fafb", 100: "#f3f4f6", 200: "#e5e7eb", 300: "#d1d5db", 400: "#9ca3af", 500: "#6b7280", 600: "#4b5563", 700: "#374151", 800: "#1f2937", 900: "#111827" };
  var h2 = { 50: "#fafafa", 100: "#f4f4f5", 200: "#e4e4e7", 300: "#d4d4d8", 400: "#a1a1aa", 500: "#71717a", 600: "#52525b", 700: "#3f3f46", 800: "#27272a", 900: "#18181b" };
  var y3 = { 50: "#fafafa", 100: "#f5f5f5", 200: "#e5e5e5", 300: "#d4d4d4", 400: "#a3a3a3", 500: "#737373", 600: "#525252", 700: "#404040", 800: "#262626", 900: "#171717" };
  var k3 = { 50: "#fafaf9", 100: "#f5f5f4", 200: "#e7e5e4", 300: "#d6d3d1", 400: "#a8a29e", 500: "#78716c", 600: "#57534e", 700: "#44403c", 800: "#292524", 900: "#1c1917" };
  ...
  var F5 = { 50: "#fffbeb", 100: "#fef3c7", 200: "#fde68a", 300: "#fcd34d", 400: "#fbbf24", 500: "#f59e0b", 600: "#d97706", 700: "#b45309", 800: "#92400e", 900: "#78350f" };
  var w5 = { 50: "#fefce8", 100: "#fef9c3", 200: "#fef08a", 300: "#fde047", 400: "#facc15", 500: "#eab308", 600: "#ca8a04", 700: "#a16207", 800: "#854d0e", 900: "#713f12" };
  ...
  var v2 = { 50: "#eff6ff", 100: "#dbeafe", 200: "#bfdbfe", 300: "#93c5fd", 400: "#60a5fa", 500: "#3b82f6", 600: "#2563eb", 700: "#1d4ed8", 800: "#1e40af", 900: "#1e3a8a" };
  ...
  var l5 = { __proto__: null, inherit: s5, current: d4, transparent: p3, black: x3, white: b2, slate: u3, gray: g4, zinc: h2, neutral: y3, stone: k3, red: C3, orange: T3, amber: F5, yellow: w5, lime: A2, green: D5, emerald: U3, teal: E, cyan: L3, sky: S3, blue: v2, indigo: z4, violet: O2, purple: R3, fuchsia: W3, pink: I2, rose: M3 };
  var H3 = { screens: { sm: "640px", md: "768px", lg: "1024px", xl: "1280px", "2xl": "1536px" }, colors: l5, columns: { auto: "auto", "3xs": "16rem", "2xs": "18rem", xs: "20rem", sm: "24rem", md: "28rem", lg: "32rem", xl: "36rem", "2xl": "42rem", "3xl": "48rem", "4xl": "56rem", "5xl": "64rem", "6xl": "72rem", "7xl": "80rem" }, spacing: { px: "1px", 0: "0px", ...a5(4, "rem", 4, 0.5, 0.5), ...a5(12, "rem", 4, 5), 14: "3.5rem", ...a5(64, "rem", 4, 16, 4), 72: "18rem", 80: "20rem", 96: "24rem" }, durations: { 75: "75ms", 100: "100ms", 150: "150ms", 200: "200ms", 300: "300ms", 500: "500ms", 700: "700ms", 1e3: "1000ms" }, animation: { none: "none", spin: "spin 1s linear infinite", ping: "ping 1s cubic-bezier(0,0,0.2,1) infinite", pulse: "pulse 2s cubic-bezier(0.4,0,0.6,1) infinite", bounce: "bounce 1s infinite" }, aspectRatio: { auto: "auto", square: "1/1", video: "16/9" }, backdropBlur: o5("blur"), backdropBrightness: o5("brightness"), backdropContrast: o5("contrast"), backdropGrayscale: o5("grayscale"), backdropHueRotate: o5("hueRotate"), backdropInvert: o5("invert"), backdropOpacity: o5("opacity"), backdropSaturate: o5("saturate"), backdropSepia: o5("sepia"), backgroundColor: o5("colors"), backgroundImage: { none: "none" }, backgroundOpacity: o5("opacity"), backgroundSize: { auto: "auto", cover: "cover", contain: "contain" }, blur: { none: "none", 0: "0", sm: "4px", DEFAULT: "8px", md: "12px", lg: "16px", xl: "24px", "2xl": "40px", "3xl": "64px" }, brightness: { ...a5(200, "", 100, 0, 50), ...a5(110, "", 100, 90, 5), 75: "0.75", 125: "1.25" }, borderColor: ({ theme: e3 }) => ({ DEFAULT: e3("colors.gray.200", "currentColor"), ...e3("colors") }), borderOpacity: o5("opacity"), borderRadius: { none: "0px", sm: "0.125rem", DEFAULT: "0.25rem", md: "0.375rem", lg: "0.5rem", xl: "0.75rem", "2xl": "1rem", "3xl": "1.5rem", "1/2": "50%", full: "9999px" }, borderSpacing: o5("spacing"), borderWidth: { DEFAULT: "1px", ...n2(8, "px") }, boxShadow: { sm: "0 1px 2px 0 rgba(0,0,0,0.05)", DEFAULT: "0 1px 3px 0 rgba(0,0,0,0.1), 0 1px 2px -1px rgba(0,0,0,0.1)", md: "0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -2px rgba(0,0,0,0.1)", lg: "0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -4px rgba(0,0,0,0.1)", xl: "0 20px 25px -5px rgba(0,0,0,0.1), 0 8px 10px -6px rgba(0,0,0,0.1)", "2xl": "0 25px 50px -12px rgba(0,0,0,0.25)", inner: "inset 0 2px 4px 0 rgba(0,0,0,0.05)", none: "0 0 #0000" }, boxShadowColor: o5("colors"), caretColor: o5("colors"), accentColor: ({ theme: e3 }) => ({ auto: "auto", ...e3("colors") }), contrast: { ...a5(200, "", 100, 0, 50), 75: "0.75", 125: "1.25" }, content: { none: "none" }, divideColor: o5("borderColor"), divideOpacity: o5("borderOpacity"), divideWidth: o5("borderWidth"), dropShadow: { sm: "0 1px 1px rgba(0,0,0,0.05)", DEFAULT: ["0 1px 2px rgba(0,0,0,0.1)", "0 1px 1px rgba(0,0,0,0.06)"], md: ["0 4px 3px rgba(0,0,0,0.07)", "0 2px 2px rgba(0,0,0,0.06)"], lg: ["0 10px 8px rgba(0,0,0,0.04)", "0 4px 3px rgba(0,0,0,0.1)"], xl: ["0 20px 13px rgba(0,0,0,0.03)", "0 8px 5px rgba(0,0,0,0.08)"], "2xl": "0 25px 25px rgba(0,0,0,0.15)", none: "0 0 #0000" }, fill: o5("colors"), grayscale: { DEFAULT: "100%", 0: "0" }, hueRotate: { 0: "0deg", 15: "15deg", 30: "30deg", 60: "60deg", 90: "90deg", 180: "180deg" }, invert: { DEFAULT: "100%", 0: "0" }, flex: { 1: "1 1 0%", auto: "1 1 auto", initial: "0 1 auto", none: "none" }, flexBasis: ({ theme: e3 }) => ({ ...e3("spacing"), ...i3(2, 6), ...i3(12, 12), auto: "auto", full: "100%" }), flexGrow: { DEFAULT: 1, 0: 0 }, flexShrink: { DEFAULT: 1, 0: 0 }, fontFamily: { sans: 'ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"'.split(","), serif: 'ui-serif,Georgia,Cambria,"Times New Roman",Times,serif'.split(","), mono: 'ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,"Liberation Mono","Courier New",monospace'.split(",") }, fontSize: { xs: ["0.75rem", "1rem"], sm: ["0.875rem", "1.25rem"], base: ["1rem", "1.5rem"], lg: ["1.125rem", "1.75rem"], xl: ["1.25rem", "1.75rem"], "2xl": ["1.5rem", "2rem"], "3xl": ["1.875rem", "2.25rem"], "4xl": ["2.25rem", "2.5rem"], "5xl": ["3rem", "1"], "6xl": ["3.75rem", "1"], "7xl": ["4.5rem", "1"], "8xl": ["6rem", "1"], "9xl": ["8rem", "1"] }, fontWeight: { thin: "100", extralight: "200", light: "300", normal: "400", medium: "500", semibold: "600", bold: "700", extrabold: "800", black: "900" }, gap: o5("spacing"), gradientColorStops: o5("colors"), gridAutoColumns: { auto: "auto", min: "min-content", max: "max-content", fr: "minmax(0,1fr)" }, gridAutoRows: { auto: "auto", min: "min-content", max: "max-content", fr: "minmax(0,1fr)" }, gridColumn: { auto: "auto", "span-full": "1 / -1" }, gridRow: { auto: "auto", "span-full": "1 / -1" }, gridTemplateColumns: { none: "none" }, gridTemplateRows: { none: "none" }, height: ({ theme: e3 }) => ({ ...e3("spacing"), ...i3(2, 6), min: "min-content", max: "max-content", fit: "fit-content", auto: "auto", full: "100%", screen: "100vh" }), inset: ({ theme: e3 }) => ({ ...e3("spacing"), ...i3(2, 4), auto: "auto", full: "100%" }), keyframes: { spin: { from: { transform: "rotate(0deg)" }, to: { transform: "rotate(360deg)" } }, ping: { "0%": { transform: "scale(1)", opacity: "1" }, "75%,100%": { transform: "scale(2)", opacity: "0" } }, pulse: { "0%,100%": { opacity: "1" }, "50%": { opacity: ".5" } }, bounce: { "0%, 100%": { transform: "translateY(-25%)", animationTimingFunction: "cubic-bezier(0.8,0,1,1)" }, "50%": { transform: "none", animationTimingFunction: "cubic-bezier(0,0,0.2,1)" } } }, letterSpacing: { tighter: "-0.05em", tight: "-0.025em", normal: "0em", wide: "0.025em", wider: "0.05em", widest: "0.1em" }, lineHeight: { ...a5(10, "rem", 4, 3), none: "1", tight: "1.25", snug: "1.375", normal: "1.5", relaxed: "1.625", loose: "2" }, margin: ({ theme: e3 }) => ({ auto: "auto", ...e3("spacing") }), maxHeight: ({ theme: e3 }) => ({ full: "100%", min: "min-content", max: "max-content", fit: "fit-content", screen: "100vh", ...e3("spacing") }), maxWidth: ({ theme: e3, breakpoints: f6 }) => ({ ...f6(e3("screens")), none: "none", 0: "0rem", xs: "20rem", sm: "24rem", md: "28rem", lg: "32rem", xl: "36rem", "2xl": "42rem", "3xl": "48rem", "4xl": "56rem", "5xl": "64rem", "6xl": "72rem", "7xl": "80rem", full: "100%", min: "min-content", max: "max-content", fit: "fit-content", prose: "65ch" }), minHeight: { 0: "0px", full: "100%", min: "min-content", max: "max-content", fit: "fit-content", screen: "100vh" }, minWidth: { 0: "0px", full: "100%", min: "min-content", max: "max-content", fit: "fit-content" }, opacity: { ...a5(100, "", 100, 0, 10), 5: "0.05", 25: "0.25", 75: "0.75", 95: "0.95" }, order: { first: "-9999", last: "9999", none: "0" }, padding: o5("spacing"), placeholderColor: o5("colors"), placeholderOpacity: o5("opacity"), outlineColor: o5("colors"), outlineOffset: n2(8, "px"), outlineWidth: n2(8, "px"), ringColor: ({ theme: e3 }) => ({ ...e3("colors"), DEFAULT: e3("colors.blue.500", "#3b82f6") }), ringOffsetColor: o5("colors"), ringOffsetWidth: n2(8, "px"), ringOpacity: ({ theme: e3 }) => ({ ...e3("opacity"), DEFAULT: "0.5" }), ringWidth: { DEFAULT: "3px", ...n2(8, "px") }, rotate: { ...n2(2, "deg"), ...n2(12, "deg", 3), ...n2(180, "deg", 45) }, saturate: a5(200, "", 100, 0, 50), scale: { ...a5(150, "", 100, 0, 50), ...a5(110, "", 100, 90, 5), 75: "0.75", 125: "1.25" }, scrollMargin: o5("spacing"), scrollPadding: o5("spacing"), sepia: { 0: "0", DEFAULT: "100%" }, skew: { ...n2(2, "deg"), ...n2(12, "deg", 3) }, space: o5("spacing"), stroke: o5("colors"), strokeWidth: a5(2), textColor: o5("colors"), textDecorationColor: o5("colors"), textDecorationThickness: { "from-font": "from-font", auto: "auto", ...n2(8, "px") }, textUnderlineOffset: { auto: "auto", ...n2(8, "px") }, textIndent: o5("spacing"), textOpacity: o5("opacity"), transitionDuration: ({ theme: e3 }) => ({ ...e3("durations"), DEFAULT: "150ms" }), transitionDelay: o5("durations"), transitionProperty: { none: "none", all: "all", DEFAULT: "color,background-color,border-color,text-decoration-color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter", colors: "color,background-color,border-color,text-decoration-color,fill,stroke", opacity: "opacity", shadow: "box-shadow", transform: "transform" }, transitionTimingFunction: { DEFAULT: "cubic-bezier(0.4,0,0.2,1)", linear: "linear", in: "cubic-bezier(0.4,0,1,1)", out: "cubic-bezier(0,0,0.2,1)", "in-out": "cubic-bezier(0.4,0,0.2,1)" }, translate: ({ theme: e3 }) => ({ ...e3("spacing"), ...i3(2, 4), full: "100%" }), width: ({ theme: e3 }) => ({ min: "min-content", max: "max-content", fit: "fit-content", screen: "100vw", ...e3("flexBasis") }), willChange: { scroll: "scroll-position" }, zIndex: { ...a5(50, "", 1, 0, 10), auto: "auto" } };
  function i3(e3, f6) {
    let t4 = {};
    do
      for (var r2 = 1; r2 < e3; r2++)
        t4[`${r2}/${e3}`] = Number((r2 / e3 * 100).toFixed(6)) + "%";
    while (++e3 <= f6);
    return t4;
  }
  function n2(e3, f6, t4 = 0) {
    let r2 = {};
    for (; t4 <= e3; t4 = 2 * t4 || 1)
      r2[t4] = t4 + f6;
    return r2;
  }
  function a5(e3, f6 = "", t4 = 1, r2 = 0, m6 = 1, c5 = {}) {
    for (; r2 <= e3; r2 += m6)
      c5[r2] = r2 / t4 + f6;
    return c5;
  }
  function o5(e3) {
    return ({ theme: f6 }) => f6(e3);
  }

  // https://esm.sh/v103/@twind/preset-tailwind@1.0.1/deno/preflight.js
  var i4 = { "*,::before,::after": { boxSizing: "border-box", borderWidth: "0", borderStyle: "solid", borderColor: "theme(borderColor.DEFAULT, currentColor)" }, "::before,::after": { "--tw-content": "''" }, html: { lineHeight: 1.5, WebkitTextSizeAdjust: "100%", MozTabSize: "4", tabSize: 4, fontFamily: `theme(fontFamily.sans, ${H3.fontFamily.sans})` }, body: { margin: "0", lineHeight: "inherit" }, hr: { height: "0", color: "inherit", borderTopWidth: "1px" }, "abbr:where([title])": { textDecoration: "underline dotted" }, "h1,h2,h3,h4,h5,h6": { fontSize: "inherit", fontWeight: "inherit" }, a: { color: "inherit", textDecoration: "inherit" }, "b,strong": { fontWeight: "bolder" }, "code,kbd,samp,pre": { fontFamily: `theme(fontFamily.mono, ${H3.fontFamily.mono})`, fontSize: "1em" }, small: { fontSize: "80%" }, "sub,sup": { fontSize: "75%", lineHeight: 0, position: "relative", verticalAlign: "baseline" }, sub: { bottom: "-0.25em" }, sup: { top: "-0.5em" }, table: { textIndent: "0", borderColor: "inherit", borderCollapse: "collapse" }, "button,input,optgroup,select,textarea": { fontFamily: "inherit", fontSize: "100%", lineHeight: "inherit", color: "inherit", margin: "0", padding: "0" }, "button,select": { textTransform: "none" }, "button,[type='button'],[type='reset'],[type='submit']": { WebkitAppearance: "button", backgroundColor: "transparent", backgroundImage: "none" }, ":-moz-focusring": { outline: "auto" }, ":-moz-ui-invalid": { boxShadow: "none" }, progress: { verticalAlign: "baseline" }, "::-webkit-inner-spin-button,::-webkit-outer-spin-button": { height: "auto" }, "[type='search']": { WebkitAppearance: "textfield", outlineOffset: "-2px" }, "::-webkit-search-decoration": { WebkitAppearance: "none" }, "::-webkit-file-upload-button": { WebkitAppearance: "button", font: "inherit" }, summary: { display: "list-item" }, "blockquote,dl,dd,h1,h2,h3,h4,h5,h6,hr,figure,p,pre": { margin: "0" }, fieldset: { margin: "0", padding: "0" }, legend: { padding: "0" }, "ol,ul,menu": { listStyle: "none", margin: "0", padding: "0" }, textarea: { resize: "vertical" }, "input::placeholder,textarea::placeholder": { opacity: 1, color: "theme(colors.gray.400, #9ca3af)" }, 'button,[role="button"]': { cursor: "pointer" }, ":disabled": { cursor: "default" }, "img,svg,video,canvas,audio,iframe,embed,object": { display: "block", verticalAlign: "middle" }, "img,video": { maxWidth: "100%", height: "auto" }, "[hidden]": { display: "none" } };
  ...
  function T4(e3) {
    for (var t4 = 9, r2 = e3.length; r2--; )
      t4 = Math.imul(t4 ^ e3.charCodeAt(r2), 1597334677);
    return "#" + ((t4 ^ t4 >>> 9) >>> 0).toString(36);
  }
  function Ce(e3, t4 = "@media ") {
    return t4 + b3(e3).map((r2) => (typeof r2 == "string" && (r2 = { min: r2 }), r2.raw || Object.keys(r2).map((i5) => `(${i5}-width:${r2[i5]})`).join(" and "))).join(",");
  }
  function b3(e3 = []) {
  ...
  function ce3({ n: e3, i: t4, v: r2 = [] }, i5, n3, l7) {
    e3 && (e3 = ae2({ n: e3, i: t4, v: r2 })), l7 = [...b3(l7)];
    for (let s8 of r2) {
      let f6 = i5.theme("screens", s8);
      for (let a7 of b3(f6 && Ce(f6) || i5.v(s8))) {
        var o6;
        l7.push(a7), n3 |= f6 ? 67108864 | re2(a7) : s8 == "dark" ? 1073741824 : a7[0] == "@" ? re2(a7) : (o6 = a7, 1 << ~(/:([a-z-]+)/.test(o6) && ~Ue.indexOf(RegExp.$1.slice(2, 7)) || -18));
      }
    }
    return { n: e3, p: n3, r: l7, i: t4 };
  }
  var pe = /* @__PURE__ */ new Map();
  function ne2(e3) {
    if (e3.d) {
      let t4 = [], r2 = H4(e3.r.reduce((i5, n3) => n3[0] == "@" ? (t4.push(n3), i5) : n3 ? H4(i5, (l7) => H4(n3, (o6) => {
        let s8 = /(:merge\(.+?\))(:[a-z-]+|\\[.+])/.exec(o6);
        if (s8) {
          let f6 = l7.indexOf(s8[1]);
          return ~f6 ? l7.slice(0, f6) + s8[0] + l7.slice(f6 + s8[1].length) : Q3(l7, o6);
        }
        return Q3(o6, l7);
      })) : i5, "&"), (i5) => Q3(i5, e3.n ? "." + Y3(e3.n) : ""));
      return r2 && t4.push(r2.replace(/:merge\((.+?)\)/g, "$1")), t4.reduceRight((i5, n3) => n3 + "{" + i5 + "}", e3.d);
    }
  }
  function H4(e3, t4) {
    return e3.replace(/ *((?:\(.+?\)|\[.+?\]|[^,])+) *(,|$)/g, (r2, i5, n3) => t4(i5) + n3);
  }
  function Q3(e3, t4) {
  ...
  function Me(e3, t4) {
    for (var r2 = 0, i5 = e3.length; r2 < i5; ) {
      let n3 = i5 + r2 >> 1;
      0 >= Ne(e3[n3], t4) ? r2 = n3 + 1 : i5 = n3;
    }
    return i5;
  }
  function Ne(e3, t4) {
    let r2 = e3.p & S4.o;
    return r2 == (t4.p & S4.o) && (r2 == S4.b || r2 == S4.o) ? 0 : e3.p - t4.p || e3.o - t4.o || $e.compare(we(e3.n), we(t4.n)) || $e.compare(Ae(e3.n), Ae(t4.n));
  }
  function we(e3) {
  ...
  function P3(e3, t4 = {}) {
    if (typeof e3 == "function")
      return e3(t4);
    let { opacityValue: r2 = "1", opacityVariable: i5 } = t4, n3 = i5 ? `var(${i5})` : r2;
    if (e3.includes("<alpha-value>"))
      return e3.replace("<alpha-value>", n3);
    if (e3[0] == "#" && (e3.length == 4 || e3.length == 7)) {
      let l7 = (e3.length - 1) / 3, o6 = [17, 1, 0.062272][l7 - 1];
      return `rgba(${[X3(e3.substr(1, l7), o6), X3(e3.substr(1 + l7, l7), o6), X3(e3.substr(1 + 2 * l7, l7), o6), n3]})`;
    }
    return n3 == "1" ? e3 : n3 == "0" ? "#0000" : e3.replace(/^(rgb|hsl)(\([^)]+)\)$/, `$1a$2,${n3})`);
  }
  function de(e3, t4, r2, i5, n3 = []) {
    return function l7(o6, { n: s8, p: f6, r: a7 = [], i: c5 }, u6) {
      let p8 = [], g7 = "", h4 = 0, $4 = 0;
      for (let y5 in o6 || {}) {
        var A4, R6;
        let d5 = o6[y5];
        if (y5[0] == "@") {
          if (!d5)
            continue;
          if (y5[1] == "a") {
            p8.push(...ge(s8, f6, I3("" + d5), u6, f6, a7, c5, true));
            continue;
          }
          if (y5[1] == "l") {
            for (let w7 of b3(d5))
              p8.push(...l7(w7, { n: s8, p: (A4 = S4[y5[7]], f6 & ~S4.o | A4), r: a7, i: c5 }, u6));
            continue;
          }
          if (y5[1] == "i") {
            p8.push(...b3(d5).map((w7) => ({ p: -1, o: 0, r: [], d: y5 + " " + w7 })));
            continue;
          }
          if (y5[1] == "k") {
            p8.push({ p: S4.d, o: 0, r: [y5], d: l7(d5, { p: S4.d }, u6).map(ne2).join("") });
            continue;
          }
          if (y5[1] == "f") {
            p8.push(...b3(d5).map((w7) => ({ p: S4.d, o: 0, r: [y5], d: l7(w7, { p: S4.d }, u6).map(ne2).join("") })));
            continue;
          }
        }
        if (typeof d5 != "object" || Array.isArray(d5))
          y5 == "label" && d5 ? s8 = d5 + T4(JSON.stringify([f6, c5, o6])) : (d5 || d5 === 0) && (y5 = y5.replace(/[A-Z]/g, (w7) => "-" + w7.toLowerCase()), $4 += 1, h4 = Math.max(h4, (R6 = y5)[0] == "-" ? 0 : Ee(R6) + (/^(?:(border-(?!w|c|sty)|[tlbr].{2,4}m?$|c.{7,8}$)|([fl].{5}l|g.{8}$|pl))/.test(R6) ? +!!RegExp.$1 || -!!RegExp.$2 : 0) + 1), g7 += (g7 ? ";" : "") + b3(d5).map((w7) => u6.s(y5, he("" + w7, u6.theme) + (c5 ? " !important" : ""))).join(";"));
        else if (y5[0] == "@" || y5.includes("&")) {
          let w7 = f6;
          y5[0] == "@" && (y5 = y5.replace(/\bscreen\(([^)]+)\)/g, (j6, M5) => {
            let N6 = u6.theme("screens", M5);
            return N6 ? (w7 |= 67108864, Ce(N6, "")) : j6;
          }), w7 |= re2(y5)), p8.push(...l7(d5, { n: s8, p: w7, r: [...a7, y5], i: c5 }, u6));
        } else
          p8.push(...l7(d5, { p: f6, r: [...a7, y5] }, u6));
      }
      return p8.unshift({ n: s8, p: f6, o: Math.max(0, 15 - $4) + 1.5 * Math.min(h4 || 15, 15), r: a7, d: g7 }), p8.sort(Ne);
    }(e3, ce3(t4, r2, i5, n3), r2);
  }
  function he(e3, t4) {
    return e3.replace(/theme\((["'`])?(.+?)\1(?:\s*,\s*(["'`])?(.+?)\3)?\)/g, (r2, i5, n3, l7, o6 = "") => {
      let s8 = t4(n3, o6);
      return typeof s8 == "function" && /color|fill|stroke/i.test(n3) ? P3(s8) : "" + b3(s8).filter((f6) => Object(f6) !== f6);
    });
  }
  function ye(e3, t4) {
    let r2, i5 = [];
    for (let n3 of e3)
      n3.d && n3.n ? r2?.p == n3.p && "" + r2.r == "" + n3.r ? (r2.c = [r2.c, n3.c].filter(Boolean).join(" "), r2.d = r2.d + ";" + n3.d) : i5.push(r2 = { ...n3, n: n3.n && t4 }) : i5.push({ ...n3, n: n3.n && t4 });
    return i5;
  }
  function W4(e3, t4, r2 = S4.u, i5, n3) {
    let l7 = [];
    for (let o6 of e3)
      for (let s8 of function(f6, a7, c5, u6, p8) {
        f6 = { ...f6, i: f6.i || p8 };
        let g7 = function(h4, $4) {
          let A4 = pe.get(h4.n);
          return A4 ? A4(h4, $4) : $4.r(h4.n, h4.v[0] == "dark");
        }(f6, a7);
        return g7 ? typeof g7 == "string" ? ({ r: u6, p: c5 } = ce3(f6, a7, c5, u6), ye(W4(I3(g7), a7, c5, u6, f6.i), f6.n)) : Array.isArray(g7) ? g7.map((h4) => {
          var $4, A4;
          return { o: 0, ...h4, r: [...b3(u6), ...b3(h4.r)], p: ($4 = c5, A4 = h4.p ?? c5, $4 & ~S4.o | A4) };
        }) : de(g7, f6, a7, c5, u6) : [{ c: ae2(f6), p: 0, o: 0, r: [] }];
      }(o6, t4, r2, i5, n3))
        l7.splice(Me(l7, s8), 0, s8);
    return l7;
  }
  function ge(e3, t4, r2, i5, n3, l7, o6, s8) {
    return ye((s8 ? r2.flatMap((f6) => W4([f6], i5, n3, l7, o6)) : W4(r2, i5, n3, l7, o6)).map((f6) => f6.p & S4.o && (f6.n || t4 == S4.b) ? { ...f6, p: f6.p & ~S4.o | t4, o: 0 } : f6), e3);
  }
  function _e2(e3, t4, r2, i5) {
    var n3;
    return n3 = (l7, o6) => {
      let { n: s8, p: f6, r: a7, i: c5 } = ce3(l7, o6, t4);
      return r2 && ge(s8, t4, r2, o6, f6, a7, c5, i5);
    }, pe.set(e3, n3), e3;
  }
  function K3(e3, t4, r2) {
    if (e3[e3.length - 1] != "(") {
      let i5 = [], n3 = false, l7 = false, o6 = "";
      for (let s8 of e3)
        if (!(s8 == "(" || /[~@]$/.test(s8))) {
          if (s8[0] == "!" && (s8 = s8.slice(1), n3 = !n3), s8.endsWith(":")) {
            i5[s8 == "dark:" ? "unshift" : "push"](s8.slice(0, -1));
            continue;
          }
          s8[0] == "-" && (s8 = s8.slice(1), l7 = !l7), s8.endsWith("-") && (s8 = s8.slice(0, -1)), s8 && s8 != "&" && (o6 += (o6 && "-") + s8);
        }
      o6 && (l7 && (o6 = "-" + o6), t4[0].push({ n: o6, v: i5.filter(Be), i: n3 }));
    }
  }
  function Be(e3, t4, r2) {
    return r2.indexOf(e3) == t4;
  }
  var Se = /* @__PURE__ */ new Map();
  function I3(e3) {
    let t4 = Se.get(e3);
    if (!t4) {
      let r2 = [], i5 = [[]], n3 = 0, l7 = 0, o6 = null, s8 = 0, f6 = (a7, c5 = 0) => {
        n3 != s8 && (r2.push(e3.slice(n3, s8 + c5)), a7 && K3(r2, i5)), n3 = s8 + 1;
      };
      for (; s8 < e3.length; s8++) {
        let a7 = e3[s8];
        if (l7)
          ...
          e3[s8 - 1] != "\\" && o6.test(e3.slice(s8)) && (o6 = null, n3 = s8 + RegExp.lastMatch.length);
        else if (a7 == "/" && e3[s8 - 1] != "\\" && (e3[s8 + 1] == "*" || e3[s8 + 1] == "/"))
          o6 = e3[s8 + 1] == "*" ? /^\*\// : /^[\r\n]/;
        else if (a7 == "(")
          f6(), r2.push(a7);
        else if (a7 == ":")
          ...
          if (a7 == ")") {
            ...
            if (/[~@]$/.test(u6)) {
              let p8 = i5.shift();
              r2.length = c5, K3([...r2, "#"], i5);
              let { v: g7 } = i5[0].pop();
              for (let h4 of p8)
                h4.v.splice(+(h4.v[0] == "dark") - +(g7[0] == "dark"), g7.length);
              K3([...r2, _e2(u6.length > 1 ? u6.slice(0, -1) + T4(JSON.stringify([u6, p8])) : u6 + "(" + ue2(p8) + ")", S4.a, p8, /@$/.test(u6))], i5);
            }
            c5 = r2.lastIndexOf("(", c5 - 1);
          }
          r2.length = c5 + 1;
        } else
          /[~@]/.test(a7) && e3[s8 + 1] == "(" && i5.unshift([]);
      }
      f6(true), Se.set(e3, t4 = i5[0]);
    }
    return t4;
  }
  function Ve(e3, t4, r2) {
    return t4.reduce((i5, n3, l7) => i5 + r2(n3) + e3[l7 + 1], e3[0]);
  }
  function Z3(e3, t4) {
    return Array.isArray(e3) && Array.isArray(e3.raw) ? Ve(e3, t4, (r2) => ee2(r2).trim()) : t4.filter(Boolean).reduce((r2, i5) => r2 + ee2(i5), e3 ? ee2(e3) : "");
  }
  function ee2(e3) {
    let t4, r2 = "";
    if (e3 && typeof e3 == "object")
      if (Array.isArray(e3))
        (t4 = Z3(e3[0], e3.slice(1))) && (r2 += " " + t4);
      else
        for (let i5 in e3)
          e3[i5] && (r2 += " " + i5);
    else
  ...
  var dt2 = ze("~");
  function ze(e3) {
    return new Proxy(function(i5, ...n3) {
      return t4("", i5, n3);
    }, { get(r2, i5) {
      return i5 in r2 ? r2[i5] : function(l7, ...o6) {
        return t4(i5, l7, o6);
      };
    } });
    function t4(r2, i5, n3) {
      return ue2(I3(r2 + e3 + "(" + Z3(i5, n3) + ")"));
    }
  }
  function G3(e3, t4) {
    return Array.isArray(e3) ? ve(Ve(e3, t4, (r2) => r2 != null && typeof r2 != "boolean" ? r2 : "")) : typeof e3 == "string" ? ve(e3) : [e3];
  }
  var We = / *(?:(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}))/g;
  function ve(e3) {
    let t4;
    ...
    let r2 = [{}], i5 = [r2[0]], n3 = [];
    for (; t4 = We.exec(e3); )
      t4[4] && (r2.shift(), n3.shift()), t4[3] ? (n3.unshift(t4[3]), r2.unshift({}), i5.push(n3.reduce((l7, o6) => ({ [o6]: l7 }), r2[0]))) : t4[4] || (r2[0][t4[1]] && (r2.unshift({}), i5.push(n3.reduce((l7, o6) => ({ [o6]: l7 }), r2[0]))), r2[0][t4[1]] = t4[2]);
    return i5;
  }
  function me(e3, ...t4) {
    var r2;
    let i5 = G3(e3, t4), n3 = (i5.find((l7) => l7.label)?.label || "css") + T4(JSON.stringify(i5));
    return r2 = (l7, o6) => ye(i5.flatMap((s8) => de(s8, l7, o6, S4.o)), n3), pe.set(n3, r2), n3;
  }
  var ht2 = new Proxy(function(e3, t4) {
    return Re("animation", e3, t4);
  }, { get(e3, t4) {
    return t4 in e3 ? e3[t4] : function(i5, n3) {
      return Re(t4, i5, n3);
    };
  } });
  function Re(e3, t4, r2) {
    return { toString() {
      return me({ label: e3, "@layer components": { ...typeof t4 == "object" ? t4 : { animation: t4 }, animationName: "" + r2 } });
    } };
  }
  function yt2(e3, t4, r2) {
    return [e3, ie(t4, r2)];
  }
  function ie(e3, t4) {
    return typeof e3 == "function" ? e3 : typeof e3 == "string" && /^[\w-]+$/.test(e3) ? (r2, i5) => ({ [e3]: t4 ? t4(r2, i5) : le(r2, 1) }) : (r2) => e3 || { [r2[1]]: le(r2, 2) };
  }
  function le(e3, t4, r2 = e3.slice(t4).find(Boolean) || e3.$$ || e3.input) {
    return e3.input[0] == "-" ? `calc(${r2} * -1)` : r2;
  }
  function gt(e3, t4, r2, i5) {
    return [e3, Ge(t4, r2, i5)];
  }
  function Ge(e3, t4, r2) {
    let i5 = typeof t4 == "string" ? (n3, l7) => ({ [t4]: r2 ? r2(n3, l7) : n3._ }) : t4 || (({ 1: n3, _: l7 }, o6, s8) => ({ [n3 || s8]: l7 }));
    return (n3, l7) => {
      let o6 = ke(e3 || n3[1]), s8 = l7.theme(o6, n3.$$) ?? oe2(n3.$$, o6, l7);
      if (s8 != null)
        return n3._ = le(n3, 0, s8), i5(n3, l7, o6);
    };
  }
  function mt2(e3, t4 = {}, r2) {
    return [e3, Ye(t4, r2)];
  }
  function Ye(e3 = {}, t4) {
    return (r2, i5) => {
      let { section: n3 = ke(r2[0]).replace("-", "") + "Color" } = e3, [l7, o6] = Ze(r2.$$);
      if (!l7)
        return;
      let s8 = i5.theme(n3, l7) || oe2(l7, n3, i5);
      if (!s8 || typeof s8 == "object")
        return;
      let { opacityVariable: f6 = `--tw-${r2[0].replace(/-$/, "")}-opacity`, opacitySection: a7 = n3.replace("Color", "Opacity"), property: c5 = n3, selector: u6 } = e3, p8 = i5.theme(a7, o6 || "DEFAULT") || o6 && oe2(o6, a7, i5), g7 = t4 || (({ _: $4 }) => {
        let A4 = He(c5, $4);
        return u6 ? { [u6]: A4 } : A4;
      });
      r2._ = { value: P3(s8, { opacityVariable: f6 || void 0, opacityValue: p8 || void 0 }), color: ($4) => P3(s8, $4), opacityVariable: f6 || void 0, opacityValue: p8 || void 0 };
      let h4 = g7(r2, i5);
      if (!r2.dark) {
        let $4 = i5.d(n3, l7, s8);
        $4 && $4 !== s8 && (r2._ = { value: P3($4, { opacityVariable: f6 || void 0, opacityValue: p8 || "1" }), color: (A4) => P3($4, A4), opacityVariable: f6 || void 0, opacityValue: p8 || void 0 }, h4 = { "&": h4, [i5.v("dark")]: g7(r2, i5) });
      }
      return h4;
    };
  }
  ...
  function He(e3, t4) {
    let r2 = {};
    return typeof t4 == "string" ? r2[e3] = t4 : (t4.opacityVariable && t4.value.includes(t4.opacityVariable) && (r2[t4.opacityVariable] = t4.opacityValue || "1"), r2[e3] = t4.value), r2;
  }
  function oe2(e3, t4, r2) {
    if (e3[0] == "[" && e3.slice(-1) == "]") {
      if (e3 = se(he(e3.slice(1, -1), r2.theme)), !t4)
        return e3;
  ...
  function se(e3) {
    return e3.includes("url(") ? e3.replace(/(.*?)(url\(.*?\))(.*?)/g, (t4, r2 = "", i5, n3 = "") => se(r2) + i5 + se(n3)) : e3.replace(/(^|[^\\])_+/g, (t4, r2) => r2 + " ".repeat(t4.length - r2.length)).replace(/\\_/g, "_").replace(/(calc|min|max|clamp)\(.+\)/g, (t4) => t4.replace(/(-?\d*\.?\d(?!\b-.+[,)](?![^+\-/*])\D)(?:%|[a-z]+)?|\))([+\-/*])/g, "$1 $2 "));
  }
  var Qe = Symbol();
  var D6 = new Proxy(F6, { apply(e3, t4, r2) {
    return B4(r2[0]);
  }, get(e3, t4) {
    let r2 = B4[t4];
    return typeof r2 == "function" ? function() {
      return r2.apply(B4, arguments);
    } : r2;
  } });
  var Rt = function e2(t4) {
    return new Proxy(function(i5, ...n3) {
      ...
      return i5 === "bind" ? e2 : i5 in r2 ? r2[i5] : function(l7, ...o6) {
        return xe2(t4, i5, l7, o6);
      };
    } });
  }();
  function xe2(e3, t4, r2, i5) {
    return { toString() {
      let n3 = G3(r2, i5), l7 = Y3(t4 + T4(JSON.stringify([t4, n3])));
      return (typeof e3 == "function" ? e3 : D6)(me({ [`@keyframes ${l7}`]: G3(r2, i5) })), l7;
    } };
  }

  // https://esm.sh/v103/@twind/preset-tailwind@1.0.1/deno/rules.js
  var j4 = [yt2("\\[([-\\w]+):(.+)]", ({ 1: t4, 2: r2 }, a7) => ({ "@layer overrides": { "&": { [t4]: oe2(`[${r2}]`, t4, a7) } } })), yt2("(group|peer)(~[^-[]+)?", ({ input: t4 }, { h: r2 }) => [{ c: r2(t4) }]), gt("aspect-", "aspectRatio"), yt2("container", (t4, { theme: r2 }) => {
    let { screens: a7 = r2("screens"), center: i5, padding: l7 } = r2("container"), d5 = { width: "100%", marginRight: i5 && "auto", marginLeft: i5 && "auto", ...g7("xs") };
    for (let f6 in a7) {
      let c5 = a7[f6];
      typeof c5 == "string" && (d5[Ce(c5)] = { "&": { maxWidth: c5, ...g7(f6) } });
    }
    return d5;
    function g7(f6) {
      let c5 = l7 && (typeof l7 == "string" ? l7 : l7[f6] || l7.DEFAULT);
      if (c5)
        return { paddingRight: c5, paddingLeft: c5 };
    }
  }), gt("content-", "content", ({ _: t4 }) => ({ "--tw-content": t4, content: "var(--tw-content)" })), yt2("(?:box-)?decoration-(slice|clone)", "boxDecorationBreak"), yt2("box-(border|content)", "boxSizing", ({ 1: t4 }) => t4 + "-box"), yt2("hidden", { display: "none" }), yt2("table-(auto|fixed)", "tableLayout"), yt2(["(block|flex|table|grid|inline|contents|flow-root|list-item)", "(inline-(block|flex|table|grid))", "(table-(caption|cell|column|row|(column|row|footer|header)-group))"], "display"), "(float)-(left|right|none)", "(clear)-(left|right|none|both)", "(overflow(?:-[xy])?)-(auto|hidden|clip|visible|scroll)", "(isolation)-(auto)", yt2("isolate", "isolation"), yt2("object-(contain|cover|fill|none|scale-down)", "objectFit"), gt("object-", "objectPosition"), yt2("object-(top|bottom|center|(left|right)(-(top|bottom))?)", "objectPosition", u4), yt2("overscroll(-[xy])?-(auto|contain|none)", ({ 1: t4 = "", 2: r2 }) => ({ ["overscroll-behavior" + t4]: r2 })), yt2("(static|fixed|absolute|relative|sticky)", "position"), gt("-?inset(-[xy])?(?:$|-)", "inset", ({ 1: t4, _: r2 }) => ({ top: t4 != "-x" && r2, right: t4 != "-y" && r2, bottom: t4 != "-x" && r2, left: t4 != "-y" && r2 })), gt("-?(top|bottom|left|right)(?:$|-)", "inset"), yt2("visible", "visibility"), yt2("invisible", { visibility: "hidden" }), gt("-?z-", "zIndex"), yt2("flex-((row|col)(-reverse)?)", "flexDirection", v3), yt2("flex-(wrap|wrap-reverse|nowrap)", "flexWrap"), gt("(flex-(?:grow|shrink))(?:$|-)"), gt("(flex)-"), gt("grow(?:$|-)", "flexGrow"), gt("shrink(?:$|-)", "flexShrink"), gt("basis-", "flexBasis"), gt("-?(order)-"), "-?(order)-(\\d+)", gt("grid-cols-", "gridTemplateColumns"), yt2("grid-cols-(\\d+)", "gridTemplateColumns", $2), gt("col-", "gridColumn"), yt2("col-(span)-(\\d+)", "gridColumn", S5), gt("col-start-", "gridColumnStart"), yt2("col-start-(auto|\\d+)", "gridColumnStart"), gt("col-end-", "gridColumnEnd"), yt2("col-end-(auto|\\d+)", "gridColumnEnd"), gt("grid-rows-", "gridTemplateRows"), yt2("grid-rows-(\\d+)", "gridTemplateRows", $2), gt("row-", "gridRow"), yt2("row-(span)-(\\d+)", "gridRow", S5), gt("row-start-", "gridRowStart"), yt2("row-start-(auto|\\d+)", "gridRowStart"), gt("row-end-", "gridRowEnd"), yt2("row-end-(auto|\\d+)", "gridRowEnd"), yt2("grid-flow-((row|col)(-dense)?)", "gridAutoFlow", (t4) => u4(v3(t4))), yt2("grid-flow-(dense)", "gridAutoFlow"), gt("auto-cols-", "gridAutoColumns"), gt("auto-rows-", "gridAutoRows"), gt("gap-x(?:$|-)", "gap", "columnGap"), gt("gap-y(?:$|-)", "gap", "rowGap"), gt("gap(?:$|-)", "gap"), "(justify-(?:items|self))-", yt2("justify-", "justifyContent", x4), yt2("(content|items|self)-", (t4) => ({ ["align-" + t4[1]]: x4(t4) })), yt2("(place-(content|items|self))-", ({ 1: t4, $$: r2 }) => ({ [t4]: ("wun".includes(r2[3]) ? "space-" : "") + r2 })), gt("p([xytrbl])?(?:$|-)", "padding", w6("padding")), gt("-?m([xytrbl])?(?:$|-)", "margin", w6("margin")), gt("-?space-(x|y)(?:$|-)", "space", ({ 1: t4, _: r2 }) => ({ "&>:not([hidden])~:not([hidden])": { [`--tw-space-${t4}-reverse`]: "0", ["margin-" + { y: "top", x: "left" }[t4]]: `calc(${r2} * calc(1 - var(--tw-space-${t4}-reverse)))`, ["margin-" + { y: "bottom", x: "right" }[t4]]: `calc(${r2} * var(--tw-space-${t4}-reverse))` } })), yt2("space-(x|y)-reverse", ({ 1: t4 }) => ({ "&>:not([hidden])~:not([hidden])": { [`--tw-space-${t4}-reverse`]: "1" } })), gt("w-", "width"), gt("min-w-", "minWidth"), gt("max-w-", "maxWidth"), gt("h-", "height"), gt("min-h-", "minHeight"), gt("max-h-", "maxHeight"), gt("font-", "fontWeight"), gt("font-", "fontFamily", "fontFamily", s6), yt2("antialiased", { WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale" }), yt2("subpixel-antialiased", { WebkitFontSmoothing: "auto", MozOsxFontSmoothing: "auto" }), yt2("italic", "fontStyle"), yt2("not-italic", { fontStyle: "normal" }), yt2("(ordinal|slashed-zero|(normal|lining|oldstyle|proportional|tabular)-nums|(diagonal|stacked)-fractions)", ({ 1: t4, 2: r2 = "", 3: a7 }) => r2 == "normal" ? { fontVariantNumeric: "normal" } : { ["--tw-" + (a7 ? "numeric-fraction" : "pt".includes(r2[0]) ? "numeric-spacing" : r2 ? "numeric-figure" : t4)]: t4, fontVariantNumeric: "var(--tw-ordinal) var(--tw-slashed-zero) var(--tw-numeric-figure) var(--tw-numeric-spacing) var(--tw-numeric-fraction)", "@layer defaults": { "*,::before,::after,::backdrop": { "--tw-ordinal": "var(--tw-empty,/*!*/ /*!*/)", "--tw-slashed-zero": "var(--tw-empty,/*!*/ /*!*/)", "--tw-numeric-figure": "var(--tw-empty,/*!*/ /*!*/)", "--tw-numeric-spacing": "var(--tw-empty,/*!*/ /*!*/)", "--tw-numeric-fraction": "var(--tw-empty,/*!*/ /*!*/)" } } }), gt("tracking-", "letterSpacing"), gt("leading-", "lineHeight"), yt2("list-(inside|outside)", "listStylePosition"), gt("list-", "listStyleType"), yt2("list-", "listStyleType"), gt("placeholder-opacity-", "placeholderOpacity", ({ _: t4 }) => ({ "&::placeholder": { "--tw-placeholder-opacity": t4 } })), mt2("placeholder-", { property: "color", selector: "&::placeholder" }), yt2("text-(left|center|right|justify|start|end)", "textAlign"), yt2("text-(ellipsis|clip)", "textOverflow"), gt("text-opacity-", "textOpacity", "--tw-text-opacity"), mt2("text-", { property: "color" }), gt("text-", "fontSize", ({ _: t4 }) => typeof t4 == "string" ? { fontSize: t4 } : { fontSize: t4[0], ...typeof t4[1] == "string" ? { lineHeight: t4[1] } : t4[1] }), gt("indent-", "textIndent"), yt2("(overline|underline|line-through)", "textDecorationLine"), yt2("no-underline", { textDecorationLine: "none" }), gt("underline-offset-", "textUnderlineOffset"), mt2("decoration-", { section: "textDecorationColor", opacityVariable: false, opacitySection: "opacity" }), gt("decoration-", "textDecorationThickness"), yt2("decoration-", "textDecorationStyle"), yt2("(uppercase|lowercase|capitalize)", "textTransform"), yt2("normal-case", { textTransform: "none" }), yt2("truncate", { overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis" }), yt2("align-", "verticalAlign"), yt2("whitespace-", "whiteSpace"), yt2("break-normal", { wordBreak: "normal", overflowWrap: "normal" }), yt2("break-words", { overflowWrap: "break-word" }), yt2("break-all", { wordBreak: "break-all" }), mt2("caret-", { opacityVariable: false, opacitySection: "opacity" }), mt2("accent-", { opacityVariable: false, opacitySection: "opacity" }), yt2("bg-gradient-to-([trbl]|[tb][rl])", "backgroundImage", ({ 1: t4 }) => `linear-gradient(to ${p4(t4, " ")},var(--tw-gradient-stops))`), mt2("from-", { section: "gradientColorStops", opacityVariable: false, opacitySection: "opacity" }, ({ _: t4 }) => ({ "--tw-gradient-from": t4.value, "--tw-gradient-to": t4.color({ opacityValue: "0" }), "--tw-gradient-stops": "var(--tw-gradient-from),var(--tw-gradient-to)" })), mt2("via-", { section: "gradientColorStops", opacityVariable: false, opacitySection: "opacity" }, ({ _: t4 }) => ({ "--tw-gradient-to": t4.color({ opacityValue: "0" }), "--tw-gradient-stops": `var(--tw-gradient-from),${t4.value},var(--tw-gradient-to)` })), mt2("to-", { section: "gradientColorStops", property: "--tw-gradient-to", opacityVariable: false, opacitySection: "opacity" }), yt2("bg-(fixed|local|scroll)", "backgroundAttachment"), yt2("bg-origin-(border|padding|content)", "backgroundOrigin", ({ 1: t4 }) => t4 + "-box"), yt2(["bg-(no-repeat|repeat(-[xy])?)", "bg-repeat-(round|space)"], "backgroundRepeat"), yt2("bg-blend-", "backgroundBlendMode"), yt2("bg-clip-(border|padding|content|text)", "backgroundClip", ({ 1: t4 }) => t4 + (t4 == "text" ? "" : "-box")), gt("bg-opacity-", "backgroundOpacity", "--tw-bg-opacity"), mt2("bg-", { section: "backgroundColor" }), gt("bg-", "backgroundImage"), gt("bg-", "backgroundPosition"), yt2("bg-(top|bottom|center|(left|right)(-(top|bottom))?)", "backgroundPosition", u4), gt("bg-", "backgroundSize"), gt("rounded(?:$|-)", "borderRadius"), gt("rounded-([trbl]|[tb][rl])(?:$|-)", "borderRadius", ({ 1: t4, _: r2 }) => {
    let a7 = { t: ["tl", "tr"], r: ["tr", "br"], b: ["bl", "br"], l: ["bl", "tl"] }[t4] || [t4, t4];
    return { [`border-${p4(a7[0])}-radius`]: r2, [`border-${p4(a7[1])}-radius`]: r2 };
  }), yt2("border-(collapse|separate)", "borderCollapse"), gt("border-opacity(?:$|-)", "borderOpacity", "--tw-border-opacity"), yt2("border-(solid|dashed|dotted|double|none)", "borderStyle"), gt("border-spacing(-[xy])?(?:$|-)", "borderSpacing", ({ 1: t4, _: r2 }) => ({ "@layer defaults": { "*,::before,::after,::backdrop": { "--tw-border-spacing-x": 0, "--tw-border-spacing-y": 0 } }, ["--tw-border-spacing" + (t4 || "-x")]: r2, ["--tw-border-spacing" + (t4 || "-y")]: r2, "border-spacing": "var(--tw-border-spacing-x) var(--tw-border-spacing-y)" })), mt2("border-([xytrbl])-", { section: "borderColor" }, w6("border", "Color")), mt2("border-"), gt("border-([xytrbl])(?:$|-)", "borderWidth", w6("border", "Width")), gt("border(?:$|-)", "borderWidth"), gt("divide-opacity(?:$|-)", "divideOpacity", ({ _: t4 }) => ({ "&>:not([hidden])~:not([hidden])": { "--tw-divide-opacity": t4 } })), yt2("divide-(solid|dashed|dotted|double|none)", ({ 1: t4 }) => ({ "&>:not([hidden])~:not([hidden])": { borderStyle: t4 } })), yt2("divide-([xy]-reverse)", ({ 1: t4 }) => ({ "&>:not([hidden])~:not([hidden])": { ["--tw-divide-" + t4]: "1" } })), gt("divide-([xy])(?:$|-)", "divideWidth", ({ 1: t4, _: r2 }) => {
    let a7 = { x: "lr", y: "tb" }[t4];
    return { "&>:not([hidden])~:not([hidden])": { [`--tw-divide-${t4}-reverse`]: "0", [`border-${p4(a7[0])}Width`]: `calc(${r2} * calc(1 - var(--tw-divide-${t4}-reverse)))`, [`border-${p4(a7[1])}Width`]: `calc(${r2} * var(--tw-divide-${t4}-reverse))` } };
  }), mt2("divide-", { property: "borderColor", selector: "&>:not([hidden])~:not([hidden])" }), gt("ring-opacity(?:$|-)", "ringOpacity", "--tw-ring-opacity"), mt2("ring-offset-", { property: "--tw-ring-offset-color", opacityVariable: false }), gt("ring-offset(?:$|-)", "ringOffsetWidth", "--tw-ring-offset-width"), yt2("ring-inset", { "--tw-ring-inset": "inset" }), mt2("ring-", { property: "--tw-ring-color" }), gt("ring(?:$|-)", "ringWidth", ({ _: t4 }, { theme: r2 }) => ({ "--tw-ring-offset-shadow": "var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color)", "--tw-ring-shadow": `var(--tw-ring-inset) 0 0 0 calc(${t4} + var(--tw-ring-offset-width)) var(--tw-ring-color)`, boxShadow: "var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow)", "@layer defaults": { "*,::before,::after,::backdrop": { "--tw-ring-offset-shadow": "0 0 #0000", "--tw-ring-shadow": "0 0 #0000", "--tw-shadow": "0 0 #0000", "--tw-shadow-colored": "0 0 #0000", "&": { "--tw-ring-inset": "var(--tw-empty,/*!*/ /*!*/)", "--tw-ring-offset-width": r2("ringOffsetWidth", "", "0px"), "--tw-ring-offset-color": P3(r2("ringOffsetColor", "", "#fff")), "--tw-ring-color": P3(r2("ringColor", "", "#93c5fd"), { opacityVariable: "--tw-ring-opacity" }), "--tw-ring-opacity": r2("ringOpacity", "", "0.5") } } } })), mt2("shadow-", { section: "boxShadowColor", opacityVariable: false, opacitySection: "opacity" }, ({ _: t4 }) => ({ "--tw-shadow-color": t4.value, "--tw-shadow": "var(--tw-shadow-colored)" })), gt("shadow(?:$|-)", "boxShadow", ({ _: t4 }) => ({ "--tw-shadow": s6(t4), "--tw-shadow-colored": s6(t4).replace(/([^,]\s+)(?:#[a-f\d]+|(?:(?:hsl|rgb)a?|hwb|lab|lch|color|var)\(.+?\)|[a-z]+)(,|$)/g, "$1var(--tw-shadow-color)$2"), boxShadow: "var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow)", "@layer defaults": { "*,::before,::after,::backdrop": { "--tw-ring-offset-shadow": "0 0 #0000", "--tw-ring-shadow": "0 0 #0000", "--tw-shadow": "0 0 #0000", "--tw-shadow-colored": "0 0 #0000" } } })), gt("(opacity)-"), yt2("mix-blend-", "mixBlendMode"), ...k4(), ...k4("backdrop-"), gt("transition(?:$|-)", "transitionProperty", (t4, { theme: r2 }) => ({ transitionProperty: s6(t4), transitionTimingFunction: t4._ == "none" ? void 0 : s6(r2("transitionTimingFunction", "")), transitionDuration: t4._ == "none" ? void 0 : s6(r2("transitionDuration", "")) })), gt("duration(?:$|-)", "transitionDuration", "transitionDuration", s6), gt("ease(?:$|-)", "transitionTimingFunction", "transitionTimingFunction", s6), gt("delay(?:$|-)", "transitionDelay", "transitionDelay", s6), gt("animate(?:$|-)", "animation", (t4, { theme: r2, h: a7 }) => {
    let i5 = s6(t4), l7 = i5.split(" "), d5 = r2("keyframes", l7[0]);
    return d5 ? { ["@keyframes " + (l7[0] = a7(l7[0]))]: d5, animation: l7.join(" ") } : { animation: i5 };
  }), "(transform)-(none)", yt2("transform", h3), yt2("transform-(cpu|gpu)", ({ 1: t4 }) => ({ "--tw-transform": C4(t4 == "gpu") })), gt("scale(-[xy])?-", "scale", ({ 1: t4, _: r2 }) => ({ ["--tw-scale" + (t4 || "-x")]: r2, ["--tw-scale" + (t4 || "-y")]: r2, ...h3() })), gt("-?(rotate)-", "rotate", y4), gt("-?(translate-[xy])-", "translate", y4), gt("-?(skew-[xy])-", "skew", y4), yt2("origin-(center|((top|bottom)(-(left|right))?)|left|right)", "transformOrigin", u4), "(appearance)-", gt("(columns)-"), "(columns)-(\\d+)", "(break-(?:before|after|inside))-", gt("(cursor)-"), "(cursor)-", yt2("snap-(none)", "scroll-snap-type"), yt2("snap-(x|y|both)", ({ 1: t4 }) => ({ "scroll-snap-type": t4 + " var(--tw-scroll-snap-strictness)", "@layer defaults": { "*,::before,::after,::backdrop": { "--tw-scroll-snap-strictness": "proximity" } } })), yt2("snap-(mandatory|proximity)", "--tw-scroll-snap-strictness"), yt2("snap-(?:(start|end|center)|align-(none))", "scroll-snap-align"), yt2("snap-(normal|always)", "scroll-snap-stop"), yt2("scroll-(auto|smooth)", "scroll-behavior"), gt("scroll-p([xytrbl])?(?:$|-)", "padding", w6("scroll-padding")), gt("-?scroll-m([xytrbl])?(?:$|-)", "scroll-margin", w6("scroll-margin")), yt2("touch-(auto|none|manipulation)", "touch-action"), yt2("touch-(pinch-zoom|pan-(?:(x|left|right)|(y|up|down)))", ({ 1: t4, 2: r2, 3: a7 }) => ({ [`--tw-${r2 ? "pan-x" : a7 ? "pan-y" : t4}`]: t4, "touch-action": "var(--tw-touch-action)", "@layer defaults": { "*,::before,::after,::backdrop": { "--tw-pan-x": "var(--tw-empty,/*!*/ /*!*/)", "--tw-pan-y": "var(--tw-empty,/*!*/ /*!*/)", "--tw-pinch-zoom": "var(--tw-empty,/*!*/ /*!*/)", "--tw-touch-action": "var(--tw-pan-x) var(--tw-pan-y) var(--tw-pinch-zoom)" } } })), yt2("outline-none", { outline: "2px solid transparent", "outline-offset": "2px" }), yt2("outline", { outlineStyle: "solid" }), yt2("outline-(dashed|dotted|double|hidden)", "outlineStyle"), gt("(outline-offset)-"), mt2("outline-", { opacityVariable: false, opacitySection: "opacity" }), gt("outline-", "outlineWidth"), "(pointer-events)-", gt("(will-change)-"), "(will-change)-", ["resize(?:-(none|x|y))?", "resize", ({ 1: t4 }) => ({ x: "horizontal", y: "vertical" })[t4] || t4 || "both"], yt2("select-(none|text|all|auto)", "userSelect"), mt2("fill-", { section: "fill", opacityVariable: false, opacitySection: "opacity" }), mt2("stroke-", { section: "stroke", opacityVariable: false, opacitySection: "opacity" }), gt("stroke-", "strokeWidth"), yt2("sr-only", { position: "absolute", width: "1px", height: "1px", padding: "0", margin: "-1px", overflow: "hidden", whiteSpace: "nowrap", clip: "rect(0,0,0,0)", borderWidth: "0" }), yt2("not-sr-only", { position: "static", width: "auto", height: "auto", padding: "0", margin: "0", overflow: "visible", whiteSpace: "normal", clip: "auto" })];
  function u4(t4) {
  ...
  function p4(t4, r2 = "-") {
    let a7 = [];
    for (let i5 of t4)
      a7.push({ t: "top", r: "right", b: "bottom", l: "left" }[i5]);
    return a7.join(r2);
  }
  function s6(t4) {
    return t4 && "" + (t4._ || t4);
  ...
  function w6(t4, r2 = "") {
    return ({ 1: a7, _: i5 }) => {
      let l7 = { x: "lr", y: "tb" }[a7] || a7 + a7;
      return l7 ? { ...He(t4 + "-" + p4(l7[0]) + r2, i5), ...He(t4 + "-" + p4(l7[1]) + r2, i5) } : He(t4 + r2, i5);
    };
  }
  function k4(t4 = "") {
    let r2 = ["blur", "brightness", "contrast", "grayscale", "hue-rotate", "invert", t4 && "opacity", "saturate", "sepia", !t4 && "drop-shadow"].filter(Boolean), a7 = {};
    for (let i5 of r2)
      a7[`--tw-${t4}${i5}`] = "var(--tw-empty,/*!*/ /*!*/)";
    return a7 = { [`${t4}filter`]: r2.map((i5) => `var(--tw-${t4}${i5})`).join(" "), "@layer defaults": { "*,::before,::after,::backdrop": a7 } }, [`(${t4}filter)-(none)`, yt2(`${t4}filter`, a7), ...r2.map((i5) => gt(`${i5[0] == "h" ? "-?" : ""}(${t4}${i5})(?:$|-)`, i5, ({ 1: l7, _: d5 }) => ({ [`--tw-${l7}`]: b3(d5).map((g7) => `${i5}(${g7})`).join(" "), ...a7 })))];
  }
  function y4({ 1: t4, _: r2 }) {
    return { ["--tw-" + t4]: r2, ...h3() };
  }
  function h3() {
  ...
  var Ae2 = (y5, o6) => () => (o6 || y5((o6 = { exports: {} }).exports, o6), o6.exports);
  var De = (y5, o6, v5, b5) => {
    if (o6 && typeof o6 == "object" || typeof o6 == "function")
      for (let m6 of Se2(o6))
        !Oe.call(y5, m6) && m6 !== v5 && xe3(y5, m6, { get: () => o6[m6], enumerable: !(b5 = He2(o6, m6)) || b5.enumerable });
    return y5;
  };
  var Ie = (y5, o6, v5) => (v5 = y5 != null ? Me2(we2(y5)) : {}, De(o6 || !y5 || !y5.__esModule ? xe3(v5, "default", { value: y5, enumerable: true }) : v5, y5));
  var ye2 = Ae2((ie3, pe2) => {
    (function(y5, o6) {
      typeof ie3 == "object" && typeof pe2 == "object" ? pe2.exports = o6() : typeof define == "function" && define.amd ? define([], o6) : typeof ie3 == "object" ? ie3.notie = o6() : y5.notie = o6();
    })(ie3, function() {
      return function(y5) {
        function o6(b5) {
          if (v5[b5])
            return v5[b5].exports;
          var m6 = v5[b5] = { i: b5, l: false, exports: {} };
          return y5[b5].call(m6.exports, m6, m6.exports, o6), m6.l = true, m6.exports;
        }
        var v5 = {};
        return o6.m = y5, o6.c = v5, o6.i = function(b5) {
          return b5;
        }, o6.d = function(b5, m6, ce4) {
          o6.o(b5, m6) || Object.defineProperty(b5, m6, { configurable: false, enumerable: true, get: ce4 });
        }, o6.n = function(b5) {
          var m6 = b5 && b5.__esModule ? function() {
            return b5.default;
          } : function() {
            return b5;
          };
          return o6.d(m6, "a", m6), m6;
        }, o6.o = function(b5, m6) {
          return Object.prototype.hasOwnProperty.call(b5, m6);
        }, o6.p = "", o6(o6.s = 1);
      }([function(y5, o6) {
        y5.exports = function(v5) {
          return v5.webpackPolyfill || (v5.deprecate = function() {
          }, v5.paths = [], v5.children || (v5.children = []), Object.defineProperty(v5, "loaded", { enumerable: true, get: function() {
            return v5.l;
          } }), Object.defineProperty(v5, "id", { enumerable: true, get: function() {
            return v5.i;
          } }), v5.webpackPolyfill = 1), v5;
        };
      }, function(y5, o6, v5) {
        "use strict";
        (function(b5) {
          var m6, ce4, re3, V5 = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(A4) {
            return typeof A4;
          } : function(A4) {
            return A4 && typeof Symbol == "function" && A4.constructor === Symbol && A4 !== Symbol.prototype ? "symbol" : typeof A4;
          };
          (function(A4, u6) {
            V5(o6) === "object" && V5(b5) === "object" ? b5.exports = u6() : (ce4 = [], m6 = u6, re3 = typeof m6 == "function" ? m6.apply(o6, ce4) : m6, re3 !== void 0 && (b5.exports = re3));
          })(void 0, function() {
            return function(A4) {
              function u6(g7) {
                if (X5[g7])
                  return X5[g7].exports;
                var T6 = X5[g7] = { i: g7, l: false, exports: {} };
                return A4[g7].call(T6.exports, T6, T6.exports, u6), T6.l = true, T6.exports;
              }
              var X5 = {};
              return u6.m = A4, u6.c = X5, u6.i = function(g7) {
                return g7;
              }, u6.d = function(g7, T6, B6) {
                u6.o(g7, T6) || Object.defineProperty(g7, T6, { configurable: false, enumerable: true, get: B6 });
              }, u6.n = function(g7) {
              ...
              function g7(t4, c5) {
                var s8 = {};
                for (var d5 in t4)
                  c5.indexOf(d5) >= 0 || Object.prototype.hasOwnProperty.call(t4, d5) && (s8[d5] = t4[d5]);
                return s8;
              }
              Object.defineProperty(u6, "__esModule", { value: true });
              var T6 = typeof Symbol == "function" && V5(Symbol.iterator) === "symbol" ? function(t4) {
                ...
                return new Promise(function(c5) {
                  return setTimeout(c5, 1e3 * t4);
                });
              }, R6 = function() {
                document.activeElement && document.activeElement.blur();
              }, W6 = function() {
                var t4 = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(c5) {
                  var s8 = 16 * Math.random() | 0, d5 = c5 === "x" ? s8 : 3 & s8 | 8;
                  return d5.toString(16);
                });
                return "notie-" + t4;
                ...
                t4.classList.add(e3.classes.container), t4.style[c5] = "-10000px", document.body.appendChild(t4), t4.style[c5] = "-" + t4.offsetHeight + "px", t4.listener && window.addEventListener("keydown", t4.listener), fe().then(function() {
                  t4.style.transition = me2(), t4.style[c5] = 0;
                });
              }, O4 = function(t4, c5) {
                var s8 = document.getElementById(t4);
                s8 && (s8.style[c5] = "-" + s8.offsetHeight + "px", s8.listener && window.removeEventListener("keydown", s8.listener), oe3(e3.transitionDuration).then(function() {
                  s8.parentNode && s8.parentNode.removeChild(s8);
                }));
              }, te = function(t4, c5) {
                var s8 = document.createElement("div");
                s8.id = e3.ids.overlay, s8.classList.add(e3.classes.overlay), s8.classList.add(e3.classes.backgroundOverlay), s8.style.opacity = 0, t4 && e3.overlayClickDismiss && (s8.onclick = function() {
                  O4(t4.id, c5), j6();
                }), document.body.appendChild(s8), fe().then(function() {
                  s8.style.transition = me2(), s8.style.opacity = e3.overlayOpacity;
                });
              }, j6 = function() {
              ...
              }, F8 = u6.hideAlerts = function(t4) {
                var c5 = document.getElementsByClassName(e3.classes.alert);
                if (c5.length) {
                  for (var s8 = 0; s8 < c5.length; s8++) {
                    var d5 = c5[s8];
                    O4(d5.id, d5.position);
                  }
                  t4 && oe3(e3.transitionDuration).then(function() {
                    return t4();
                  });
                }
              }, he2 = u6.alert = function(t4) {
                var c5 = t4.type, s8 = c5 === void 0 ? 4 : c5, d5 = t4.text, i5 = t4.time, k6 = i5 === void 0 ? e3.alertTime : i5, H6 = t4.stay, S8 = H6 !== void 0 && H6, h4 = t4.position, p8 = h4 === void 0 ? e3.positions.alert || p8.top : h4;
                R6(), F8();
                var l7 = document.createElement("div"), f6 = W6();
                l7.id = f6, l7.position = p8, l7.classList.add(e3.classes.textbox), l7.classList.add(le2[s8]), l7.classList.add(e3.classes.alert), l7.innerHTML = '<div class="' + e3.classes.textboxInner + '">' + d5 + "</div>", l7.onclick = function() {
                  return O4(f6, p8);
                }, l7.listener = function(n3) {
                  ($4(n3) || ee3(n3)) && F8();
                }, K5(l7, p8), k6 && k6 < 1 && (k6 = 1), !S8 && k6 && oe3(k6).then(function() {
                  return O4(f6, p8);
                });
              }, ke2 = u6.force = function(t4, c5) {
                var s8 = t4.type, d5 = s8 === void 0 ? 5 : s8, i5 = t4.text, k6 = t4.buttonText, H6 = k6 === void 0 ? "OK" : k6, S8 = t4.callback, h4 = t4.position, p8 = h4 === void 0 ? e3.positions.force || p8.top : h4;
                R6(), F8();
                var l7 = document.createElement("div"), f6 = W6();
                l7.id = f6;
                var n3 = document.createElement("div");
                n3.classList.add(e3.classes.textbox), n3.classList.add(e3.classes.backgroundInfo), n3.innerHTML = '<div class="' + e3.classes.textboxInner + '">' + i5 + "</div>";
                var r2 = document.createElement("div");
                r2.classList.add(e3.classes.button), r2.classList.add(le2[d5]), r2.innerHTML = H6, r2.onclick = function() {
                  O4(f6, p8), j6(), S8 ? S8() : c5 && c5();
                }, l7.appendChild(n3), l7.appendChild(r2), l7.listener = function(C6) {
                  $4(C6) && r2.click();
                }, K5(l7, p8), te();
              }, Ce2 = u6.confirm = function(t4, c5, s8) {
                var d5 = t4.text, i5 = t4.submitText, k6 = i5 === void 0 ? "Yes" : i5, H6 = t4.cancelText, S8 = H6 === void 0 ? "Cancel" : H6, h4 = t4.submitCallback, p8 = t4.cancelCallback, l7 = t4.position, f6 = l7 === void 0 ? e3.positions.confirm || f6.top : l7;
                R6(), F8();
                var n3 = document.createElement("div"), r2 = W6();
                n3.id = r2;
                var C6 = document.createElement("div");
                C6.classList.add(e3.classes.textbox), C6.classList.add(e3.classes.backgroundInfo), C6.innerHTML = '<div class="' + e3.classes.textboxInner + '">' + d5 + "</div>";
                ...
                x6.classList.add(e3.classes.button), x6.classList.add(e3.classes.elementHalf), x6.classList.add(e3.classes.backgroundSuccess), x6.innerHTML = k6, x6.onclick = function() {
                  O4(r2, f6), j6(), h4 ? h4() : c5 && c5();
                };
                var a7 = document.createElement("div");
                a7.classList.add(e3.classes.button), a7.classList.add(e3.classes.elementHalf), a7.classList.add(e3.classes.backgroundError), a7.innerHTML = S8, a7.onclick = function() {
                  O4(r2, f6), j6(), p8 ? p8() : s8 && s8();
                }, n3.appendChild(C6), n3.appendChild(x6), n3.appendChild(a7), n3.listener = function(E3) {
                  $4(E3) ? x6.click() : ee3(E3) && a7.click();
                }, K5(n3, f6), te(n3, f6);
              }, ve2 = function(t4, c5, s8) {
                var d5 = t4.text, i5 = t4.submitText, k6 = i5 === void 0 ? "Submit" : i5, H6 = t4.cancelText, S8 = H6 === void 0 ? "Cancel" : H6, h4 = t4.submitCallback, p8 = t4.cancelCallback, l7 = t4.position, f6 = l7 === void 0 ? e3.positions.input || f6.top : l7, n3 = g7(t4, ["text", "submitText", "cancelText", "submitCallback", "cancelCallback", "position"]);
                R6(), F8();
                var r2 = document.createElement("div"), C6 = W6();
                r2.id = C6;
                var x6 = document.createElement("div");
                x6.classList.add(e3.classes.textbox), x6.classList.add(e3.classes.backgroundInfo), x6.innerHTML = '<div class="' + e3.classes.textboxInner + '">' + d5 + "</div>";
                var a7 = document.createElement("input");
                a7.classList.add(e3.classes.inputField), a7.setAttribute("autocapitalize", n3.autocapitalize || "none"), a7.setAttribute("autocomplete", n3.autocomplete || "off"), a7.setAttribute("autocorrect", n3.autocorrect || "off"), a7.setAttribute("autofocus", n3.autofocus || "true"), a7.setAttribute("inputmode", n3.inputmode || "verbatim"), a7.setAttribute("max", n3.max || ""), a7.setAttribute("maxlength", n3.maxlength || ""), a7.setAttribute("min", n3.min || ""), a7.setAttribute("minlength", n3.minlength || ""), a7.setAttribute("placeholder", n3.placeholder || ""), a7.setAttribute("spellcheck", n3.spellcheck || "default"), a7.setAttribute("step", n3.step || "any"), a7.setAttribute("type", n3.type || "text"), a7.value = n3.value || "", n3.allowed && (a7.oninput = function() {
                  var M5 = void 0;
                  if (Array.isArray(n3.allowed)) {
                    for (var w7 = "", _2 = n3.allowed, P5 = 0; P5 < _2.length; P5++)
                      _2[P5] === "an" ? w7 += "0-9a-zA-Z" : _2[P5] === "a" ? w7 += "a-zA-Z" : _2[P5] === "n" && (w7 += "0-9"), _2[P5] === "s" && (w7 += " ");
                    M5 = new RegExp("[^" + w7 + "]", "g");
                  } else
                    T6(n3.allowed) === "object" && (M5 = n3.allowed);
                  a7.value = a7.value.replace(M5, "");
                });
                var E3 = document.createElement("div");
                E3.classList.add(e3.classes.button), E3.classList.add(e3.classes.elementHalf), E3.classList.add(e3.classes.backgroundSuccess), E3.innerHTML = k6, E3.onclick = function() {
                  O4(C6, f6), j6(), h4 ? h4(a7.value) : c5 && c5(a7.value);
                };
                ...
                D9.classList.add(e3.classes.button), D9.classList.add(e3.classes.elementHalf), D9.classList.add(e3.classes.backgroundError), D9.innerHTML = S8, D9.onclick = function() {
                  O4(C6, f6), j6(), p8 ? p8(a7.value) : s8 && s8(a7.value);
                }, r2.appendChild(x6), r2.appendChild(a7), r2.appendChild(E3), r2.appendChild(D9), r2.listener = function(M5) {
                  $4(M5) ? E3.click() : ee3(M5) && D9.click();
                }, K5(r2, f6), a7.focus(), te(r2, f6);
              };
              u6.input = ve2;
              var Ee2 = u6.select = function(t4, c5) {
                var s8 = t4.text, d5 = t4.cancelText, i5 = d5 === void 0 ? "Cancel" : d5, k6 = t4.cancelCallback, H6 = t4.choices, S8 = t4.position, h4 = S8 === void 0 ? e3.positions.select || h4.top : S8;
                R6(), F8();
                var p8 = document.createElement("div"), l7 = W6();
                p8.id = l7;
                var f6 = document.createElement("div");
                f6.classList.add(e3.classes.textbox), f6.classList.add(e3.classes.backgroundInfo), f6.innerHTML = '<div class="' + e3.classes.textboxInner + '">' + s8 + "</div>", p8.appendChild(f6), H6.forEach(function(r2, C6) {
                  var x6 = r2.type, a7 = x6 === void 0 ? 1 : x6, E3 = r2.text, D9 = r2.handler, M5 = document.createElement("div");
                  M5.classList.add(le2[a7]), M5.classList.add(e3.classes.button), M5.classList.add(e3.classes.selectChoice);
                  var w7 = H6[C6 + 1];
                  w7 && !w7.type && (w7.type = 1), w7 && w7.type === a7 && M5.classList.add(e3.classes.selectChoiceRepeated), M5.innerHTML = E3, M5.onclick = function() {
                    O4(l7, h4), j6(), D9();
                  }, p8.appendChild(M5);
                });
                var n3 = document.createElement("div");
                n3.classList.add(e3.classes.backgroundNeutral), n3.classList.add(e3.classes.button), n3.innerHTML = i5, n3.onclick = function() {
                  O4(l7, h4), j6(), k6 ? k6() : c5 && c5();
                }, p8.appendChild(n3), p8.listener = function(r2) {
                  ee3(r2) && n3.click();
                }, K5(p8, h4), te(p8, h4);
              }, Te = u6.date = function(t4, c5, s8) {
                var d5 = t4.value, i5 = d5 === void 0 ? new Date() : d5, k6 = t4.submitText, H6 = k6 === void 0 ? "OK" : k6, S8 = t4.cancelText, h4 = S8 === void 0 ? "Cancel" : S8, p8 = t4.submitCallback, l7 = t4.cancelCallback, f6 = t4.position, n3 = f6 === void 0 ? e3.positions.date || n3.top : f6;
                R6(), F8();
                var r2 = "&#9662", C6 = document.createElement("div"), x6 = document.createElement("div"), a7 = document.createElement("div"), E3 = function(L5) {
                  C6.innerHTML = e3.dateMonths[L5.getMonth()], x6.innerHTML = L5.getDate(), a7.innerHTML = L5.getFullYear();
                }, D9 = function(L5) {
                  var N6 = new Date(i5.getFullYear(), i5.getMonth() + 1, 0).getDate(), Q5 = L5.target.textContent.replace(/^0+/, "").replace(/[^\d]/g, "").slice(0, 2);
                  Number(Q5) > N6 && (Q5 = N6.toString()), L5.target.textContent = Q5, Number(Q5) < 1 && (Q5 = "1"), i5.setDate(Number(Q5));
                }, M5 = function(L5) {
                  var N6 = L5.target.textContent.replace(/^0+/, "").replace(/[^\d]/g, "").slice(0, 4);
                  L5.target.textContent = N6, i5.setFullYear(Number(N6));
                }, w7 = function(L5) {
                  E3(i5);
                }, _2 = function(L5) {
                  var N6 = new Date(i5.getFullYear(), i5.getMonth() + L5 + 1, 0).getDate();
                  i5.getDate() > N6 && i5.setDate(N6), i5.setMonth(i5.getMonth() + L5), E3(i5);
                }, P5 = function(L5) {
                  i5.setDate(i5.getDate() + L5), E3(i5);
                }, be = function(L5) {
                  var N6 = i5.getFullYear() + L5;
                  N6 < 0 ? i5.setFullYear(0) : i5.setFullYear(i5.getFullYear() + L5), E3(i5);
                ...
                Z4.classList.add(e3.classes.button), Z4.classList.add(e3.classes.elementThird), Z4.classList.add(e3.classes.dateSelectorUp), Z4.innerHTML = r2;
                var q5 = document.createElement("div");
                q5.classList.add(e3.classes.button), q5.classList.add(e3.classes.elementThird), q5.classList.add(e3.classes.dateSelectorUp), q5.innerHTML = r2;
                var G5 = document.createElement("div");
                G5.classList.add(e3.classes.button), G5.classList.add(e3.classes.elementThird), G5.classList.add(e3.classes.dateSelectorUp), G5.innerHTML = r2, C6.classList.add(e3.classes.element), C6.classList.add(e3.classes.elementThird), C6.innerHTML = e3.dateMonths[i5.getMonth()], x6.classList.add(e3.classes.element), x6.classList.add(e3.classes.elementThird), x6.setAttribute("contentEditable", true), x6.addEventListener("input", D9), x6.addEventListener("blur", w7), x6.innerHTML = i5.getDate(), a7.classList.add(e3.classes.element), a7.classList.add(e3.classes.elementThird), a7.setAttribute("contentEditable", true), a7.addEventListener("input", M5), a7.addEventListener("blur", w7), a7.innerHTML = i5.getFullYear();
                var ne3 = document.createElement("div");
                ne3.classList.add(e3.classes.button), ne3.classList.add(e3.classes.elementThird), ne3.innerHTML = r2;
                var se2 = document.createElement("div");
                se2.classList.add(e3.classes.button), se2.classList.add(e3.classes.elementThird), se2.innerHTML = r2;
                var ae3 = document.createElement("div");
                ae3.classList.add(e3.classes.button), ae3.classList.add(e3.classes.elementThird), ae3.innerHTML = r2, Z4.onclick = function() {
                  return _2(1);
                }, q5.onclick = function() {
                  return P5(1);
                }, G5.onclick = function() {
                ...
                z6.classList.add(e3.classes.button), z6.classList.add(e3.classes.elementHalf), z6.classList.add(e3.classes.backgroundSuccess), z6.innerHTML = H6, z6.onclick = function() {
                  O4(de2, n3), j6(), p8 ? p8(i5) : c5 && c5(i5);
                };
                ...
                U5.classList.add(e3.classes.button), U5.classList.add(e3.classes.elementHalf), U5.classList.add(e3.classes.backgroundError), U5.innerHTML = h4, U5.onclick = function() {
                  O4(de2, n3), j6(), l7 ? l7(i5) : s8 && s8(i5);
                }, I5.appendChild(Z4), I5.appendChild(q5), I5.appendChild(G5), I5.appendChild(C6), I5.appendChild(x6), I5.appendChild(a7), I5.appendChild(ne3), I5.appendChild(se2), I5.appendChild(ae3), ue3.appendChild(I5), Y5.appendChild(ue3), Y5.appendChild(z6), Y5.appendChild(U5), Y5.listener = function(L5) {
                  $4(L5) ? z6.click() : ee3(L5) && U5.click();
                }, K5(Y5, n3), te(Y5, n3);
              };
              u6.default = { alert: he2, force: ke2, confirm: Ce2, input: ve2, select: Ee2, date: Te, setOptions: ge2, hideAlerts: F8 };
            }]);
          });
        }).call(o6, v5(0)(y5));
      }]);
  ...
  function p6(r2) {
    return (n3) => {
      if (n3.transform) {
        let e3 = n3.transform;
        return n3 = n3.input, { input: n3, transform(t4, o6, s8) {
          let f6 = r2(t4, o6, ...s8);
          return (...l7) => e3(t4, f6, l7);
        } };
      } else
        return { input: n3, transform(e3, t4, o6) {
          return r2(e3, t4, ...o6);
        } };
    };
  }
  var N4 = p6((r2, n3, e3) => g5(n3, (t4) => {
    for (let o6 in e3)
      t4 = t4.replace(new RegExp(`{${o6}}`, "g"), e3[o6]);
    return t4;
  }));
  var R4 = p6((r2, n3, e3) => {
    let t4 = new Intl.PluralRules(r2).select(e3);
    return t4 in n3 || (t4 = "many"), g5(n3[t4], (o6) => o6.replace(/{count}/g, e3));
  });
  ...
  function P4(e3, t4, i5, r2) {
    e3.addEventListener ? e3.addEventListener(t4, i5, r2) : e3.attachEvent && e3.attachEvent("on".concat(t4), function() {
      i5(window.event);
    });
  }
  function T5(e3, t4) {
    for (var i5 = t4.slice(0, t4.length - 1), r2 = 0; r2 < i5.length; r2++)
      i5[r2] = e3[i5[r2].toLowerCase()];
    return i5;
  }
  function U4(e3) {
    typeof e3 != "string" && (e3 = ""), e3 = e3.replace(/\s/g, "");
    for (var t4 = e3.split(","), i5 = t4.lastIndexOf(""); i5 >= 0; )
      t4[i5 - 1] += ",", t4.splice(i5, 1), i5 = t4.lastIndexOf("");
    return t4;
  }
  function G4(e3, t4) {
    for (var i5 = e3.length >= t4.length ? e3 : t4, r2 = e3.length >= t4.length ? t4 : e3, n3 = true, a7 = 0; a7 < i5.length; a7++)
      r2.indexOf(i5[a7]) === -1 && (n3 = false);
    return n3;
  }
  ...
  var g6 = { "\u21E7": 16, shift: 16, "\u2325": 18, alt: 18, option: 18, "\u2303": 17, ctrl: 17, control: 17, "\u2318": 91, cmd: 91, command: 91 };
  var L4 = { 16: "shiftKey", 18: "altKey", 17: "ctrlKey", 91: "metaKey", shiftKey: 16, ctrlKey: 17, altKey: 18, metaKey: 91 };
  var u5 = { 16: false, 18: false, 17: false, 91: false };
  var s7 = {};
  for (O3 = 1; O3 < 20; O3++)
  ...
  var H5 = [];
  var C5 = function(t4) {
    return b4[t4.toLowerCase()] || g6[t4.toLowerCase()] || t4.toUpperCase().charCodeAt(0);
  };
  var R5 = function(t4) {
    return Object.keys(b4).find(function(i5) {
      return b4[i5] === t4;
    });
  };
  var V4 = function(t4) {
    return Object.keys(g6).find(function(i5) {
      return g6[i5] === t4;
    });
  };
  function F7(e3) {
  ...
  function $3() {
    return f5.map(function(e3) {
      return R5(e3) || V4(e3) || String.fromCharCode(e3);
    });
  }
  function q4(e3) {
    var t4 = e3.target || e3.srcElement, i5 = t4.tagName, r2 = true;
    return (t4.isContentEditable || (i5 === "INPUT" || i5 === "TEXTAREA" || i5 === "SELECT") && !t4.readOnly) && (r2 = false), r2;
  }
  function z5(e3) {
    return typeof e3 == "string" && (e3 = C5(e3)), f5.indexOf(e3) !== -1;
  }
  function J2(e3, t4) {
    var i5, r2;
    e3 || (e3 = E2());
    for (var n3 in s7)
      if (Object.prototype.hasOwnProperty.call(s7, n3))
        for (i5 = s7[n3], r2 = 0; r2 < i5.length; )
          i5[r2].scope === e3 ? i5.splice(r2, 1) : r2++;
    E2() === e3 && F7(t4 || "all");
  }
  function N5(e3) {
    var t4 = e3.keyCode || e3.which || e3.charCode, i5 = f5.indexOf(t4);
    if (i5 >= 0 && f5.splice(i5, 1), e3.key && e3.key.toLowerCase() === "meta" && f5.splice(0, f5.length), (t4 === 93 || t4 === 224) && (t4 = 91), t4 in u5) {
      u5[t4] = false;
      for (var r2 in g6)
        g6[r2] === t4 && (v4[r2] = false);
    }
  }
  function Q4(e3) {
    if (typeof e3 > "u")
      Object.keys(s7).forEach(function(o6) {
        return delete s7[o6];
      });
    else if (Array.isArray(e3))
      e3.forEach(function(o6) {
        o6.key && S7(o6);
      });
    else if (typeof e3 == "object")
      e3.key && S7(e3);
    else if (typeof e3 == "string") {
      for (var t4 = arguments.length, i5 = new Array(t4 > 1 ? t4 - 1 : 0), r2 = 1; r2 < t4; r2++)
        i5[r2 - 1] = arguments[r2];
      var n3 = i5[0], a7 = i5[1];
      typeof n3 == "function" && (a7 = n3, n3 = ""), S7({ key: e3, scope: n3, method: a7, splitKey: "+" });
    }
  }
  var S7 = function(t4) {
    var i5 = t4.key, r2 = t4.scope, n3 = t4.method, a7 = t4.splitKey, o6 = a7 === void 0 ? "+" : a7, l7 = U4(i5);
    l7.forEach(function(c5) {
      var p8 = c5.split(o6), m6 = p8.length, y5 = p8[m6 - 1], d5 = y5 === "*" ? "*" : C5(y5);
      if (s7[d5]) {
        r2 || (r2 = E2());
        var K5 = m6 > 1 ? T5(g6, p8) : [];
        s7[d5] = s7[d5].filter(function(h4) {
          var w7 = n3 ? h4.method === n3 : true;
          return !(w7 && h4.scope === r2 && G4(h4.mods, K5));
        });
      }
    });
  };
  function _(e3, t4, i5, r2) {
    if (t4.element === r2) {
      var n3;
      if (t4.scope === i5 || t4.scope === "all") {
        n3 = t4.mods.length > 0;
        for (var a7 in u5)
          Object.prototype.hasOwnProperty.call(u5, a7) && (!u5[a7] && t4.mods.indexOf(+a7) > -1 || u5[a7] && t4.mods.indexOf(+a7) === -1) && (n3 = false);
        (t4.mods.length === 0 && !u5[16] && !u5[18] && !u5[17] && !u5[91] || n3 || t4.shortcut === "*") && t4.method(e3, t4) === false && (e3.preventDefault ? e3.preventDefault() : e3.returnValue = false, e3.stopPropagation && e3.stopPropagation(), e3.cancelBubble && (e3.cancelBubble = true));
      }
    }
  }
  function k5(e3, t4) {
    var i5 = s7["*"], r2 = e3.keyCode || e3.which || e3.charCode;
    if (v4.filter.call(this, e3)) {
      if ((r2 === 93 || r2 === 224) && (r2 = 91), f5.indexOf(r2) === -1 && r2 !== 229 && f5.push(r2), ["ctrlKey", "altKey", "shiftKey", "metaKey"].forEach(function(h4) {
        var w7 = L4[h4];
        e3[h4] && f5.indexOf(w7) === -1 ? f5.push(w7) : !e3[h4] && f5.indexOf(w7) > -1 ? f5.splice(f5.indexOf(w7), 1) : h4 === "metaKey" && e3[h4] && f5.length === 3 && (e3.ctrlKey || e3.shiftKey || e3.altKey || (f5 = f5.slice(f5.indexOf(w7))));
      }), r2 in u5) {
        u5[r2] = true;
        for (var n3 in g6)
          g6[n3] === r2 && (v4[n3] = true);
      ...
      for (var a7 in u5)
        Object.prototype.hasOwnProperty.call(u5, a7) && (u5[a7] = e3[L4[a7]]);
      e3.getModifierState && !(e3.altKey && !e3.ctrlKey) && e3.getModifierState("AltGraph") && (f5.indexOf(17) === -1 && f5.push(17), f5.indexOf(18) === -1 && f5.push(18), u5[17] = true, u5[18] = true);
      var o6 = E2();
      if (i5)
        for (var l7 = 0; l7 < i5.length; l7++)
          i5[l7].scope === o6 && (e3.type === "keydown" && i5[l7].keydown || e3.type === "keyup" && i5[l7].keyup) && _(e3, i5[l7], o6, t4);
      if (r2 in s7) {
        for (var c5 = 0; c5 < s7[r2].length; c5++)
          if ((e3.type === "keydown" && s7[r2][c5].keydown || e3.type === "keyup" && s7[r2][c5].keyup) && s7[r2][c5].key) {
            for (var p8 = s7[r2][c5], m6 = p8.splitKey, y5 = p8.key.split(m6), d5 = [], K5 = 0; K5 < y5.length; K5++)
              d5.push(C5(y5[K5]));
            d5.sort().join("") === f5.sort().join("") && _(e3, p8, o6, t4);
          }
      }
    }
  }
  ...
  function v4(e3, t4, i5) {
    f5 = [];
    var r2 = U4(e3), n3 = [], a7 = "all", o6 = document, l7 = 0, c5 = false, p8 = true, m6 = "+", y5 = false;
    for (i5 === void 0 && typeof t4 == "function" && (i5 = t4), Object.prototype.toString.call(t4) === "[object Object]" && (t4.scope && (a7 = t4.scope), t4.element && (o6 = t4.element), t4.keyup && (c5 = t4.keyup), t4.keydown !== void 0 && (p8 = t4.keydown), t4.capture !== void 0 && (y5 = t4.capture), typeof t4.splitKey == "string" && (m6 = t4.splitKey)), typeof t4 == "string" && (a7 = t4); l7 < r2.length; l7++)
      e3 = r2[l7].split(m6), n3 = [], e3.length > 1 && (n3 = T5(g6, e3)), e3 = e3[e3.length - 1], e3 = e3 === "*" ? "*" : C5(e3), e3 in s7 || (s7[e3] = []), s7[e3].push({ keyup: c5, keydown: p8, scope: a7, mods: n3, shortcut: r2[l7], method: i5, key: r2[l7], splitKey: m6, element: o6 });
    typeof o6 < "u" && !W5(o6) && window && (H5.push(o6), P4(o6, "keydown", function(d5) {
      k5(d5, o6);
    }, y5), A3 || (A3 = true, P4(window, "focus", function() {
      f5 = [];
    }, y5)), P4(o6, "keyup", function(d5) {
      k5(d5, o6), N5(d5);
    }, y5));
  }
  function Y4(e3) {
    var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "all";
    Object.keys(s7).forEach(function(i5) {
      var r2 = s7[i5].filter(function(n3) {
  ...
  var j5 = { getPressedKeyString: $3, setScope: F7, getScope: E2, deleteScope: J2, getPressedKeyCodes: X4, isPressed: z5, filter: q4, trigger: Y4, unbind: Q4, keyMap: b4, modifier: g6, modifierMap: L4 };
  for (x5 in j5)
    Object.prototype.hasOwnProperty.call(j5, x5) && (v4[x5] = j5[x5]);
  var x5;
  typeof document < "u" && (B5 = window.hotkeys, v4.noConflict = function(e3) {
    return e3 && window.hotkeys === v4 && (window.hotkeys = B5), v4;
  }, window.hotkeys = v4);
  var B5;
  ...
  var Timing = class {
    ...
    stop(message) {
      ...
      const d5 = Math.round(now - this.#t);
  ...
  function md5cmn(q5, a7, b5, x6, s8, t4) {
    return safeAdd(bitRotateLeft(safeAdd(safeAdd(a7, q5), safeAdd(x6, t4)), s8), b5);
  }
  function md5ff(a7, b5, c5, d5, x6, s8, t4) {
    return md5cmn(b5 & c5 | ~b5 & d5, a7, b5, x6, s8, t4);
  }
  function md5gg(a7, b5, c5, d5, x6, s8, t4) {
    return md5cmn(b5 & d5 | c5 & ~d5, a7, b5, x6, s8, t4);
  }
  function md5hh(a7, b5, c5, d5, x6, s8, t4) {
    return md5cmn(b5 ^ c5 ^ d5, a7, b5, x6, s8, t4);
  }
  function md5ii(a7, b5, c5, d5, x6, s8, t4) {
    return md5cmn(c5 ^ (b5 | ~d5), a7, b5, x6, s8, t4);
  }
  function binlMD5(x6, len) {
    ...
    var c5 = -1732584194;
    var d5 = 271733878;
    for (i5 = 0; i5 < x6.length; i5 += 16) {
      olda = a7;
      oldb = b5;
      oldc = c5;
      oldd = d5;
      a7 = md5ff(a7, b5, c5, d5, x6[i5], 7, -680876936);
      d5 = md5ff(d5, a7, b5, c5, x6[i5 + 1], 12, -389564586);
      c5 = md5ff(c5, d5, a7, b5, x6[i5 + 2], 17, 606105819);
      b5 = md5ff(b5, c5, d5, a7, x6[i5 + 3], 22, -1044525330);
      a7 = md5ff(a7, b5, c5, d5, x6[i5 + 4], 7, -176418897);
      d5 = md5ff(d5, a7, b5, c5, x6[i5 + 5], 12, 1200080426);
      c5 = md5ff(c5, d5, a7, b5, x6[i5 + 6], 17, -1473231341);
      b5 = md5ff(b5, c5, d5, a7, x6[i5 + 7], 22, -45705983);
      a7 = md5ff(a7, b5, c5, d5, x6[i5 + 8], 7, 1770035416);
      d5 = md5ff(d5, a7, b5, c5, x6[i5 + 9], 12, -1958414417);
      c5 = md5ff(c5, d5, a7, b5, x6[i5 + 10], 17, -42063);
      b5 = md5ff(b5, c5, d5, a7, x6[i5 + 11], 22, -1990404162);
      a7 = md5ff(a7, b5, c5, d5, x6[i5 + 12], 7, 1804603682);
      d5 = md5ff(d5, a7, b5, c5, x6[i5 + 13], 12, -40341101);
      c5 = md5ff(c5, d5, a7, b5, x6[i5 + 14], 17, -1502002290);
      b5 = md5ff(b5, c5, d5, a7, x6[i5 + 15], 22, 1236535329);
      a7 = md5gg(a7, b5, c5, d5, x6[i5 + 1], 5, -165796510);
      d5 = md5gg(d5, a7, b5, c5, x6[i5 + 6], 9, -1069501632);
      c5 = md5gg(c5, d5, a7, b5, x6[i5 + 11], 14, 643717713);
      b5 = md5gg(b5, c5, d5, a7, x6[i5], 20, -373897302);
      a7 = md5gg(a7, b5, c5, d5, x6[i5 + 5], 5, -701558691);
      d5 = md5gg(d5, a7, b5, c5, x6[i5 + 10], 9, 38016083);
      c5 = md5gg(c5, d5, a7, b5, x6[i5 + 15], 14, -660478335);
      b5 = md5gg(b5, c5, d5, a7, x6[i5 + 4], 20, -405537848);
      a7 = md5gg(a7, b5, c5, d5, x6[i5 + 9], 5, 568446438);
      d5 = md5gg(d5, a7, b5, c5, x6[i5 + 14], 9, -1019803690);
      c5 = md5gg(c5, d5, a7, b5, x6[i5 + 3], 14, -187363961);
      b5 = md5gg(b5, c5, d5, a7, x6[i5 + 8], 20, 1163531501);
      a7 = md5gg(a7, b5, c5, d5, x6[i5 + 13], 5, -1444681467);
      d5 = md5gg(d5, a7, b5, c5, x6[i5 + 2], 9, -51403784);
      c5 = md5gg(c5, d5, a7, b5, x6[i5 + 7], 14, 1735328473);
      b5 = md5gg(b5, c5, d5, a7, x6[i5 + 12], 20, -1926607734);
      a7 = md5hh(a7, b5, c5, d5, x6[i5 + 5], 4, -378558);
      d5 = md5hh(d5, a7, b5, c5, x6[i5 + 8], 11, -2022574463);
      c5 = md5hh(c5, d5, a7, b5, x6[i5 + 11], 16, 1839030562);
      b5 = md5hh(b5, c5, d5, a7, x6[i5 + 14], 23, -35309556);
      a7 = md5hh(a7, b5, c5, d5, x6[i5 + 1], 4, -1530992060);
      d5 = md5hh(d5, a7, b5, c5, x6[i5 + 4], 11, 1272893353);
      c5 = md5hh(c5, d5, a7, b5, x6[i5 + 7], 16, -155497632);
      b5 = md5hh(b5, c5, d5, a7, x6[i5 + 10], 23, -1094730640);
      a7 = md5hh(a7, b5, c5, d5, x6[i5 + 13], 4, 681279174);
      d5 = md5hh(d5, a7, b5, c5, x6[i5], 11, -358537222);
      c5 = md5hh(c5, d5, a7, b5, x6[i5 + 3], 16, -722521979);
      b5 = md5hh(b5, c5, d5, a7, x6[i5 + 6], 23, 76029189);
      a7 = md5hh(a7, b5, c5, d5, x6[i5 + 9], 4, -640364487);
      d5 = md5hh(d5, a7, b5, c5, x6[i5 + 12], 11, -421815835);
      c5 = md5hh(c5, d5, a7, b5, x6[i5 + 15], 16, 530742520);
      b5 = md5hh(b5, c5, d5, a7, x6[i5 + 2], 23, -995338651);
      a7 = md5ii(a7, b5, c5, d5, x6[i5], 6, -198630844);
      d5 = md5ii(d5, a7, b5, c5, x6[i5 + 7], 10, 1126891415);
      c5 = md5ii(c5, d5, a7, b5, x6[i5 + 14], 15, -1416354905);
      b5 = md5ii(b5, c5, d5, a7, x6[i5 + 5], 21, -57434055);
      a7 = md5ii(a7, b5, c5, d5, x6[i5 + 12], 6, 1700485571);
      d5 = md5ii(d5, a7, b5, c5, x6[i5 + 3], 10, -1894986606);
      c5 = md5ii(c5, d5, a7, b5, x6[i5 + 10], 15, -1051523);
      b5 = md5ii(b5, c5, d5, a7, x6[i5 + 1], 21, -2054922799);
      a7 = md5ii(a7, b5, c5, d5, x6[i5 + 8], 6, 1873313359);
      d5 = md5ii(d5, a7, b5, c5, x6[i5 + 15], 10, -30611744);
      c5 = md5ii(c5, d5, a7, b5, x6[i5 + 6], 15, -1560198380);
      b5 = md5ii(b5, c5, d5, a7, x6[i5 + 13], 21, 1309151649);
      a7 = md5ii(a7, b5, c5, d5, x6[i5 + 4], 6, -145523070);
      d5 = md5ii(d5, a7, b5, c5, x6[i5 + 11], 10, -1120210379);
      c5 = md5ii(c5, d5, a7, b5, x6[i5 + 2], 15, 718787259);
      b5 = md5ii(b5, c5, d5, a7, x6[i5 + 9], 21, -343485551);
      a7 = safeAdd(a7, olda);
      b5 = safeAdd(b5, oldb);
      c5 = safeAdd(c5, oldc);
      d5 = safeAdd(d5, oldd);
  ...
  function binl2rstr(input) {
    ...
    for (i5 = 0; i5 < length32; i5 += 8) {
      output += String.fromCharCode(input[i5 >> 5] >>> i5 % 32 & 255);
    }
    return output;
  }
  function rstr2binl(input) {
    ...
    for (i5 = 0; i5 < length8; i5 += 8) {
      output[i5 >> 5] |= (input.charCodeAt(i5 / 8) & 255) << i5 % 32;
    }
    return output;
  }
  function rstrMD5(s8) {
    return binl2rstr(binlMD5(rstr2binl(s8), s8.length * 8));
  }
  function rstrHMACMD5(key, data) {
    ...
    for (i5 = 0; i5 < 16; i5 += 1) {
      ipad[i5] = bkey[i5] ^ 909522486;
      opad[i5] = bkey[i5] ^ 1549556828;
    }
  ...
  function rstr2hex(input) {
    ...
    var x6;
    var i5;
    for (i5 = 0; i5 < input.length; i5 += 1) {
      x6 = input.charCodeAt(i5);
  ...
  function rawMD5(s8) {
    return rstrMD5(str2rstrUTF8(s8));
  }
  function hexMD5(s8) {
    return rstr2hex(rawMD5(s8));
  }
  function rawHMACMD5(k6, d5) {
    return rstrHMACMD5(str2rstrUTF8(k6), str2rstrUTF8(d5));
  }
  function hexHMACMD5(k6, d5) {
    return rstr2hex(rawHMACMD5(k6, d5));
  }
  ...
  function splitStentenceWithMaxLength(sentences, maxLength) {
    ...
    for (let i5 = 0; i5 < sentences.length; i5++) {
      const currentSentence = sentences[i5];
      ...
      for (let j6 = 0; j6 < textArrSplitedByNewLine.length; j6++) {
        const currentText = textArrSplitedByNewLine[j6];
        if (currentText === "") {
          if (currentTempSentences.length > 0) {
            if (j6 < textArrSplitedByNewLine.length - 1) {
          ...
          if (currentText.length > maxLength) {
            ...
            for (let k6 = 0; k6 < tempSplitedSentences.length; k6++) {
              const tempSentence = tempSplitedSentences[k6];
        ...
        if (currentTempSentences.length > 0 && j6 < textArrSplitedByNewLine.length - 1) {
          currentTempSentences[currentTempSentences.length - 1].suffix += "\n";
        }
      }
  ...
  async function sendMessage(options2) {
    const c5 = getConnection();
    const response = await c5.sendMessage(
      "background:main",
      options2
    );
    return response;
  ...
  function sendPageTranslatedStatus(status) {
    ...
    const c5 = getConnection();
    c5.sendMessage("popup:main_sync", {
  ...
  function getContainers(root2, ctx) {
    ...
    finalContainers.sort(function(a7, b5) {
      return a7.compareDocumentPosition(b5) & Node.DOCUMENT_POSITION_FOLLOWING ? -1 : 1;
    });
  ...
  function elementsToParagraph(elements, isPreWhitespace, ctx) {
    ...
    for (let i5 = 0; i5 < elements.length; i5++) {
      const elementState = elements[i5];
  ...
  async function getParagraphs2(_root, containers, ctx, targetContainers) {
    const allParagraphs = [];
    const { targetLanguage, rule, isDetectParagraphLanguage } = ctx;
    for (let i5 = 0; i5 < containers.length; i5++) {
      const container = containers[i5];
      const targetContainer = targetContainers[i5];
      if (!targetContainer) {
  ...
  var Translation = class {
    ...
    async multipleTranslate(payload, everySentenceCallback) {
      ...
      for (let i5 = 0; i5 < tempSentenceGroups.length; i5++) {
        const tempSentenceGroup = tempSentenceGroups[i5];
        ...
        try {
          ...
          if (everySentenceCallback) {
            ...
            for (let i6 = currentSentenceIndex; i6 < sentences.length; i6++) {
              const sentence = sentences[i6];
              everySentenceCallback(e3, null, sentence);
            }
            globalError = e3;
            continue;
        ...
        for (let j6 = 0; j6 < translatedTexts.length; j6++) {
          try {
            const translatedText = translatedTexts[j6];
            const tempSentence = tempSentenceGroup.tempSentences[j6];
  ...
  Sha256.prototype.update = function(message) {
    ...
    var code2, index = 0, i5, length = message.length, blocks2 = this.blocks;
    while (index < length) {
      if (this.hashed) {
        this.hashed = false;
      ...
      if (notString) {
        ...
        for (i5 = this.start; index < length && i5 < 64; ++index) {
          ...
          if (code2 < 128) {
            blocks2[i5 >> 2] |= code2 << SHIFT[i5++ & 3];
          } else if (code2 < 2048) {
            blocks2[i5 >> 2] |= (192 | code2 >> 6) << SHIFT[i5++ & 3];
            blocks2[i5 >> 2] |= (128 | code2 & 63) << SHIFT[i5++ & 3];
          } else if (code2 < 55296 || code2 >= 57344) {
            blocks2[i5 >> 2] |= (224 | code2 >> 12) << SHIFT[i5++ & 3];
            blocks2[i5 >> 2] |= (128 | code2 >> 6 & 63) << SHIFT[i5++ & 3];
            blocks2[i5 >> 2] |= (128 | code2 & 63) << SHIFT[i5++ & 3];
          } else {
            code2 = 65536 + ((code2 & 1023) << 10 | message.charCodeAt(++index) & 1023);
            blocks2[i5 >> 2] |= (240 | code2 >> 18) << SHIFT[i5++ & 3];
            blocks2[i5 >> 2] |= (128 | code2 >> 12 & 63) << SHIFT[i5++ & 3];
            blocks2[i5 >> 2] |= (128 | code2 >> 6 & 63) << SHIFT[i5++ & 3];
            blocks2[i5 >> 2] |= (128 | code2 & 63) << SHIFT[i5++ & 3];
          }
        }
  ...
  Sha256.prototype.hash = function() {
    var a7 = this.h0, b5 = this.h1, c5 = this.h2, d5 = this.h3, e3 = this.h4, f6 = this.h5, g7 = this.h6, h4 = this.h7, blocks2 = this.blocks, j6, s0, s1, maj, t1, t22, ch, ab, da, cd, bc;
    for (j6 = 16; j6 < 64; ++j6) {
      t1 = blocks2[j6 - 15];
      s0 = (t1 >>> 7 | t1 << 25) ^ (t1 >>> 18 | t1 << 14) ^ t1 >>> 3;
      t1 = blocks2[j6 - 2];
      s1 = (t1 >>> 17 | t1 << 15) ^ (t1 >>> 19 | t1 << 13) ^ t1 >>> 10;
      blocks2[j6] = blocks2[j6 - 16] + s0 + blocks2[j6 - 7] + s1 << 0;
    }
    bc = b5 & c5;
    for (j6 = 0; j6 < 64; j6 += 4) {
      if (this.first) {
        ...
        s0 = (a7 >>> 2 | a7 << 30) ^ (a7 >>> 13 | a7 << 19) ^ (a7 >>> 22 | a7 << 10);
        s1 = (e3 >>> 6 | e3 << 26) ^ (e3 >>> 11 | e3 << 21) ^ (e3 >>> 25 | e3 << 7);
        ab = a7 & b5;
        maj = ab ^ a7 & c5 ^ bc;
        ch = e3 & f6 ^ ~e3 & g7;
        t1 = h4 + s1 + ch + K4[j6] + blocks2[j6];
        t22 = s0 + maj;
        h4 = d5 + t1 << 0;
        d5 = t1 + t22 << 0;
      }
      s0 = (d5 >>> 2 | d5 << 30) ^ (d5 >>> 13 | d5 << 19) ^ (d5 >>> 22 | d5 << 10);
      s1 = (h4 >>> 6 | h4 << 26) ^ (h4 >>> 11 | h4 << 21) ^ (h4 >>> 25 | h4 << 7);
      da = d5 & a7;
      maj = da ^ d5 & b5 ^ ab;
      ch = h4 & e3 ^ ~h4 & f6;
      t1 = g7 + s1 + ch + K4[j6 + 1] + blocks2[j6 + 1];
      t22 = s0 + maj;
      g7 = c5 + t1 << 0;
      c5 = t1 + t22 << 0;
      ...
      maj = cd ^ c5 & a7 ^ da;
      ch = g7 & h4 ^ ~g7 & e3;
      t1 = f6 + s1 + ch + K4[j6 + 2] + blocks2[j6 + 2];
      t22 = s0 + maj;
      f6 = b5 + t1 << 0;
      b5 = t1 + t22 << 0;
      s0 = (b5 >>> 2 | b5 << 30) ^ (b5 >>> 13 | b5 << 19) ^ (b5 >>> 22 | b5 << 10);
      s1 = (f6 >>> 6 | f6 << 26) ^ (f6 >>> 11 | f6 << 21) ^ (f6 >>> 25 | f6 << 7);
      bc = b5 & c5;
      maj = bc ^ b5 & d5 ^ cd;
      ch = f6 & g7 ^ ~f6 & h4;
      t1 = e3 + s1 + ch + K4[j6 + 3] + blocks2[j6 + 3];
      t22 = s0 + maj;
      e3 = a7 + t1 << 0;
      a7 = t1 + t22 << 0;
    }
    this.h0 = this.h0 + a7 << 0;
    this.h1 = this.h1 + b5 << 0;
    this.h2 = this.h2 + c5 << 0;
    this.h3 = this.h3 + d5 << 0;
    this.h4 = this.h4 + e3 << 0;
    this.h5 = this.h5 + f6 << 0;
    ...
    if (type === "string") {
      ...
      for (i5 = 0; i5 < length; ++i5) {
        ...
        if (code2 < 128) {
          ...
          code2 = 65536 + ((code2 & 1023) << 10 | key.charCodeAt(++i5) & 1023);
  ...
  function generateJobs(sentences, beams = 1) {
    ...
    let id = 0;
    for (let i5 = 0; i5 < sentences.length; i5++) {
      const chunks = sentences[i5].chunks;
      for (let j6 = 0; j6 < chunks.length; j6++) {
        const chunk = chunks[j6];
        jobs.push({
          kind: "default",
          _index: i5,
          sentences: [{
...
`);
    ...
    canonicalHeaders() {
      ...
      headers2.sort((a7, b5) => a7[0].toLowerCase() < b5[0].toLowerCase() ? -1 : 1);
      const parts = [];
  ...
  var Youdao = class extends Translation {
    ...
    async translate(payload) {
      ...
      const result = res;
      const l7 = result.l;
      const [remoteFrom, _2] = l7.split("2");
      return {
  ...
  async function translateMultipleSentences(payload, ctx, everySentenceCallback) {
    ...
    const noCacheResult = await translator.multipleTranslate(
      ...
      (err, a7, b5) => {
        if (everySentenceCallback) {
          everySentenceCallback(err, a7, b5);
          if (!err && a7 && !defaultTranslationEngine.startsWith("mock") && config.cache) {
            let cacheServiceKey = defaultTranslationEngine;
            if (defaultTranslationEngine === "openl") {
              cacheServiceKey = defaultTranslationEngine + "-" + serviceConfig.codename || openl_default.DEFAULT_CODENAME;
            }
            if (config.cache) {
              deadline(
                setDbStore(
                  {
                    translatedText: a7.text,
                    from: b5.from,
                    to: b5.to,
                    detectedFrom: a7.from,
                    key: md5(b5.text),
                    service: cacheServiceKey
                  }
                ),
    ...
    for (const sentence of noCacheResult.sentences) {
      const index = finalResult.sentences.findIndex((s8) => !s8);
      if (index === -1) {
  ...
  function isAVersionGreaterOrEqualWithB(a7, b5) {
    const result = a7.localeCompare(b5, void 0, {
      numeric: true,
      sensitivity: "base"
    });
    return result >= 0;
  ...
  function useTranslate(rawOptions, translations2) {
    ...
    return { lang, setLang, t: t4, isReady };
  }

  // https://esm.sh/stable/preact@10.11.0/deno/jsx-runtime.js
  var a6 = 0;
  function p7(n3, s8, t4, f6, u6) {
    var r2, o6, _2 = {};
    for (o6 in s8)
      o6 == "ref" ? r2 = s8[o6] : _2[o6] = s8[o6];
    var e3 = { type: n3, props: _2, key: t4, ref: r2, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: --a6, __source: u6, __self: f6 };
    if (typeof n3 == "function" && (r2 = n3.defaultProps))
      for (o6 in r2)
        _2[o6] === void 0 && (_2[o6] = r2[o6]);
  ...
  var TranslateProvider = (props) => {
    const { t: t4, setLang, lang, isReady } = useTranslate(
      {
    ...
    return /* @__PURE__ */ p7(TranslateContext.Provider, {
      value: {
        t: t4,
        setLang,
        lang,
  ...
  function handleSourceLanguageUrlPattern(url, language, currentSourceLanguageUrlPattern) {
    ...
    if (!currentSourceLanguageUrlPattern[language]) {
      currentSourceLanguageUrlPattern[language] = {
        "matches": [],
        "excludeMatches": []
      };
    }
    currentMatches = currentSourceLanguageUrlPattern[language].matches;
    const currentMatchSet = new Set(currentMatches);
    if (language === "auto") {
      currentMatchSet.delete(url);
    } else {
  ...
  function SelectLink(props) {
    ...
    return /* @__PURE__ */ p7("select", {
      ...
      children: items.map((item) => /* @__PURE__ */ p7("option", {
        value: item.value,
  ...
  function SelectDropDown(props) {
    ...
    return /* @__PURE__ */ p7("select", {
      ...
      children: [{
        value: DEFAULT_VALUE,
        label: props.label
      }].concat(menus).map((item) => /* @__PURE__ */ p7("option", {
        value: item.value,
        children: item.label
      }))
    });
  ...
  function Popup(props) {
    ...
    let isAlwaysTranslateWildUrl = null;
    let isNeverTranslateUrl = null;
    let isNeverTranslateWildUrl = null;
    ...
    if (config) {
      ...
      if (currentUrl && isValidHtmlUrl(currentUrl)) {
        ...
        isAlwaysTranslateWildUrl = matches.includes(currentWildHostname);
        isAlwaysTranslateUrl = matches.includes(currentUrlObj.hostname);
        isNeverTranslateWildUrl = excludeMatches.includes(currentWildHostname);
        isNeverTranslateUrl = excludeMatches.includes(currentUrlObj.hostname);
      }
    }
    ...
    let translateTheWholePageLabel = t4("translateTheWholePage");
    let translateToThePageEndImmediatelyLabel = t4(
      "translateToThePageEndImmediately"
    );
    let translateTheMainPageLabel = t4("translateTheMainPage");
    if (pageStatus2 === "Original" || pageStatus2 === "Translated") {
      ...
      if (config.shortcuts.toggleTranslateTheWholePage) {
        translateTheWholePageLabel += ` (${config.shortcuts.toggleTranslateTheWholePage})`;
      }
      ...
      if (config.shortcuts.toggleTranslateTheMainPage) {
        translateTheMainPageLabel += ` (${config.shortcuts.toggleTranslateTheMainPage})`;
      }
    }
      ...
      children: [
        /* @__PURE__ */ p7("div", {
          ...
          children: [
            ...
            config && config.targetLanguage && /* @__PURE__ */ p7("div", {
              class: "flex justify-between mb-2",
              children: [
                /* @__PURE__ */ p7("label", {
                  class: "inline-block",
            ...
            curentTranslationServiceItem && translationServiceItems.length > 0 && /* @__PURE__ */ p7(L, {
              children: [
                /* @__PURE__ */ p7("div", {
                  class: "flex justify-between mb-2",
                  children: [
                ...
                currentTranslationServiceConfig && curentTranslationServiceItem.props.length > 0 && curentTranslationServiceItem.props.map((prop, index) => {
                  return /* @__PURE__ */ p7("div", {
                    class: "pl-4 text-sm",
                    children: /* @__PURE__ */ p7(PopupField, {
                      root: root2,
                      size: "sm",
                      field: prop,
                  ...
                  items: [
                    {
                      label: t4("default"),
                      value: "default",
                      selected: isAlwaysTranslateUrl === false && isNeverTranslateUrl === false && isAlwaysTranslateWildUrl && isNeverTranslateWildUrl,
                      onSelected: () => {
                    ...
                    },
                    {
                      ...
                      onSelected: (item) => {
                        handleTranslationUrlPatternSelected(
                          item.value,
                          currentUrlObj.hostname,
                          [currentUrlObj.hostname, currentWildHostname],
                          [currentWildHostname]
                        );
                      }
                    },
                    ...
                    currentWildHostname && {
                      ...
                      value: "matchesWild",
                      selected: isAlwaysTranslateWildUrl,
                      onSelected: () => {
                        handleTranslationUrlPatternSelected(
                          "matches",
                          currentWildHostname,
                    ...
                    currentWildHostname && {
                      ...
                      selected: isNeverTranslateWildUrl,
                      onSelected: () => {
                        handleTranslationUrlPatternSelected(
                          "excludeMatches",
                          currentWildHostname,
        ...
        /* @__PURE__ */ p7("div", {
          ...
          children: [
            currentLang !== "auto" ? /* @__PURE__ */ p7("label", {
              ...
              children: [
                ...
                t4("alwaysTranslateSomeLanguage", {
                  language: t4(`languages.${currentLang}`)
                })
              ]
            }) : /* @__PURE__ */ p7("span", {}),
            /* @__PURE__ */ p7(SelectDropDown, {
              label: t4("more"),
              showArrow: true,
              onSelected: (item) => {
              ...
              menus: [
                config.translationArea === "main" && {
                  label: translateTheWholePageLabel,
                  value: "translateTheWholePage"
                },
                config.translationArea === "body" && {
                  label: translateTheMainPageLabel,
                  value: "translateTheMainPage"
                },
                {
                ...
                !isMonkey() && {
                  label: t4("browser.translateLocalPdfFile"),
                  value: "translateLocalPdfFile"
                },
                {
                  label: "\u2615\uFE0F " + t4("sponsorLabel"),
                  value: "donate"
                },
                {
                  label: "\u{1F41B} " + t4("feedback"),
                  value: "feedback"
                },
                {
                  label: "\u2699\uFE0F " + t4("browser.openOptionsPage"),
                  value: "options"
                }
              ].filter(Boolean)
            })
  ...
  function PopupApp(props) {
    ...
    const handletranslateToThePageEndImmediately = () => {
      translateToThePageEndImmediately();
      onClose();
    };
    const handleTranslateTheMainPage = () => {
  ...
  function initPopup() {
    ...
    script.textContent = env4.IMMERSIVE_TRANSLATE_POPUP_JS;
    ...
    document.addEventListener("click", (e3) => {
      if (e3.target.id !== "immersive-translate-popup") {
        showButton();
      }
    });
  }
  function renderPopup(shadow) {
    ...
    (async () => {
      ...
      re(
        /* @__PURE__ */ p7(TranslateProvider, {
          lang: config.interfaceLanguage,
          fallbackLang: "zh-CN",
          translations: locales_default,
          children: /* @__PURE__ */ p7(PopupApp, {
  ...
  function toggleTranslatePage2() {
    toggleTranslatePage().catch((e3) => {
      console.error(`Translate page error:`, e3);
    });
  }
